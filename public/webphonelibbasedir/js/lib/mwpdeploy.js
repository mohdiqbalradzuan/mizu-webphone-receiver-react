    ...
    u = {
      ...
      getJREs: function () {
        ...
        if (this.isPluginInstalled())
          for (
            var n = this.getPlugin(), i = n.jvms, a = 0;
            a < i.getLength();
            a++
          )
            t[a] = i.get(a).version;
        ...
        if (this.debug)
          for (var a = 0; a < t.length; ++a)
            e("[getJREs()] We claim to have detected Java SE " + t[a]);
        return t;
      },
      installJRE: function (e, t) {
        setTimeout(function () {
          ...
          "MSIE" === webphone_api.GetBrowser() &&
            ...
            webphone_api.common.UserChooseEnginePopup(
              e,
              !0,
              !1,
              function () {},
      ...
      isAutoInstallEnabled: function (e) {
        return !!this.isPluginInstalled() && (void 0 === e && (e = null), r(e));
      },
      ...
      installLatestJRE: function (e) {
        ...
        return "true" == this.EAInstallEnabled &&
          ...
          : "MSIE" == i
          ? this.IEInstall()
          : "Netscape Family" == i && -1 != a.indexOf("win32")
          ? this.FFInstall()
          : ((location.href = n(
              (null != this.returnPage
      ...
      runApplet: function (t, n, i) {
        ...
        if (
          ...
          e(
            "[runApplet()] Invalid minimumVersion argument to runApplet():" + i,
          );
      },
      writeAppletTag: function (e, t) {
        ...
        var s = !1;
        for (var o in t)
          "codebase_lookup" == o && (s = !0),
            ("object" != o && "java_object" != o && "java_code" != o) ||
              (r = !1),
            (i += '<param name="' + o + '" value="' + t[o] + '"/>');
        s || (i += '<param name="codebase_lookup" value="false"/>'),
          r && (n += ' code="dummy"'),
          (n += ">"),
      ...
      versionCheck: function (t) {
        ...
        if (null != i) {
          for (var a = !1, r = !1, l = new Array(), s = 1; s < i.length; ++s)
            "string" == typeof i[s] && "" != i[s] && ((l[n] = i[s]), n++);
          "+" == l[l.length - 1]
            ? ((r = !0), (a = !1), l.length--)
            : "*" == l[l.length - 1]
            ? ((r = !1), (a = !0), l.length--)
            : l.length < 4 && ((r = !1), (a = !0));
          for (var o = this.getJREs(), s = 0; s < o.length; ++s)
            if (this.compareVersionToPattern(o[s], l, a, r)) return !0;
          return !1;
        }
      ...
      setAutoUpdateEnabled: function () {
        return (
          !!this.isPluginInstalled() && this.getPlugin().setAutoUpdateEnabled()
        );
      },
      ...
      compareVersionToPattern: function (e, t, n, i) {
        ...
        var a = e.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$");
        if (null != a) {
          for (var r = 0, l = new Array(), s = 1; s < a.length; ++s)
            "string" == typeof a[s] && "" != a[s] && ((l[r] = a[s]), r++);
          ...
          for (var s = 0; s < o; ++s) if (l[s] != t[s]) return !1;
          return !!n || l.length == t.length;
        }
        return !1;
      },
      getBrowser: function () {
      ...
      compareVersions: function (e, t) {
        for (var n = e.split("."), i = t.split("."), a = 0; a < n.length; ++a)
          n[a] = Number(n[a]);
        for (var a = 0; a < i.length; ++a) i[a] = Number(i[a]);
        return (
          2 == n.length && (n[2] = 0),
          n[0] > i[0] ||
            (!(n[0] < i[0]) &&
              (n[1] > i[1] ||
                (!(n[1] < i[1]) && (n[2] > i[2] || !(n[2] < i[2])))))
        );
      },
      ...
      writePluginTag: function () {
        ...
        if ("MSIE" == e) {
          ...
          (n = document.createElement("object")),
            (n.classid = "clsid:CAFEEFAC-DEC7-0000-0001-ABCDEFFEDCBA"),
            (n.id = "deployJavaPlugin"),
            n.width && (n.width = "0"),
            n.height && (n.height = "0");
          ...
          if (void 0 === i || null === i) {
            try {
              console.log(
                "ERROR, cannot create OBJECT element deployJavaPlugin",
              );
            } catch (a) {}
            return;
          }
