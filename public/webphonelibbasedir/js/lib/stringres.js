...
webphone_api.stringres = (function () {
  var StringResources = {
    ...
    callback: "Callback",
    callback_src:
      "Enter your mobile phone number<br>(begining with country code)",
    ...
    logview_help:
      "Copy the content of the logs window and send it in an emial to:",
    ...
    sync_message:
      "Sync will work only after you have uploaded contacts from mobile device.",
    ...
    contact_delete_all_msg:
      "Are you sure you want to delet all the contacts?<br>This will permanently delete the whole contact list!",
    ...
    call_forward_warn:
      "Call forward will work only if the remote peer has support for it.",
    ...
    np_popup_msg:
      "You must install service plugin in order for the softphone to work.",
    ...
    ce_native_ios_safari:
      "Your browser does not support WebRTC. Please use the native application.",
    ce_native_ios_not_safari:
      "Your browser does not support WebRTC. Please switch to Safari browser or use the native application.",
    ...
    app_en_warning:
      "Your browser does not have any built-in or plugin VoIP support.<br>Launching native VoIP client...",
    app_en_warning_short: "Browser has no built-in or plugin VoIP support.",
    app_en_message:
      "VoIP is not supported by your browser. Will launch native app. (this message will not be displayed in the production release).",
    app_en_message2:
      "VoIP is not supported by your browser. Launch native app ?",
    app_en_message3:
      "Your VoIP server is not reachable over WebRTC or not configured. Start native app ?",
    np_install_title: "Service plugin",
    np_install_msg:
      "Please launch the installer once downloaded.<br>Click OK when install finished.",
    np_install_msg_lin:
      "Please download, extract (unzip) and execute the installer <br>(You can lauch the .run file from your terminal console).",
    ...
    hint_phone_number:
      "Enter here phone number, sip account username or SIP URI",
    ...
    hint_integration:
      "Add click to call functionality by converting numbers to clickable links",
    ...
    chrome_https:
      "For Chrome, Opera and Firefox version 68 and above, we recommend to host the webphone on secure http (https), otherwise WebRTC will not work.",
    webrtc_local_sipserver: "Local WebRTC server required!",
    chrome_https_reload:
      "For Chrome, Opera and Firefox version 68 and above, the WebRTC will only work from secure http (https). \n\n Click OK to reload the page using mizu https proxy.",
    all_demo_msg:
      "Note: these messages are displayed only in demo version, in final build these situations are handled automatically",
    mac_app:
      "No engines available in your environment. Please contact your service provider.",
    name: "Name",
    ...
    filter_warning:
      'At leaset "Start with" or "Replace with" field must be entered.',
    ...
    accounts_hint_callerid:
      "SIP username (extension id / user id / phone number / DID / A number / AOR)",
    accounts_hint_displayname:
      "Your full name to be displayed on the called side",
    ...
    accounts_instructions2:
      "The selected account will be the main account for outbound calls. Incoming calls can be received on all accounts.",
    ...
    java_freeze_ff:
      'After you have accepted to "Run this application",\nClick OK to continue',
    ...
    hint_more: "More",
    ce_ask_user:
      "It seems that [SELECTEDENGINE] engine is not working. Switch to [RECOMMENDED] ?",
    ...
    only_ns_engine3:
      "Only the Java VoIP engine is enabled, but not available in your browser. Please use a Java applet compatible browser such as Internet Explorer.",
    only_ns_engine4:
      "Only the Java VoIP engine is enabled, but not available in your browser. Please use a Java applet compatible browser.",
    only_app_engine1:
    ...
    smscode_instrucation:
      "You should receive your sign-in code now by SMS. Please enter your sign-in code:",
    ...
    username_err:
      "The username contains unsupported special characters, please rewrite",
    password_err:
      "The password contains unsupported special characters, please rewrite",
    ...
    service_update:
      "A new version of the NS VoIP engine is available.<br> Please download and launch the executable to upgrade.",
    ...
    usenative_option_webrtc:
      "Ignore and start (webrtc) in web browser right now",
    ...
    hint_speedtest:
      "Test your internet connection bandwith, packet loss and latency",
    ...
    request_permission2:
      "Allow [BRANDNAME] to use your microphone and/or camera.<br><br>It may be possible that you have blocked access before to microphone and/or camera devices. In this case go to your browser settings and enable access for this domain.",
    warning_msg_1:
    ...
    dtmfmode_op_4:
      "NTE (Named Telephone Events as specified in RFC2833 and RFC 4733)",
    ...
    importonlywithnum__no:
      "No (import all users even with no valid phone number)",
    importonlywithnum__yes: "Yes (import only users with phone number)",
    incomingcallpopup__no: "No",
    incomingcallpopup__auto:
      "Auto (show only if browser window is not in foreground/focused)",
    ...
    androidspeaker__before_fcall:
      "Switch off speakerphone before the first call",
    ...
    agc__guess: "Guess",
    use_fast_ice__no:
      "No (set to 0 only if your server needs to always route the media)",
    ...
    earlymedia__auto:
      "Auto (will early open audio if wideband is enabled to check if supported)",
    ...
    callreceiver__enablewhilerunning:
      "Enable incoming calls (while app is running - no background listener)",
    ...
    addaccount_msg:
      "Fill in the following details in order to create a new account",
    ...
    chrome_ext_enable:
      "Click on the below link and enable Screen Capturing chrome extension",
    ...
    sett_comment_androidspeaker:
      "Specify the default playback device on Android",
    ...
    sett_comment_dropsameoldcall:
      "Drop call if same call is received multiple times",
    ...
    sett_comment_filters:
      "Add destination number rewrite rules (add/remove/rewrite prefix)",
    sett_comment_short_filters: "",

    sett_display_name_earlymedia: "Send early media",
    sett_comment_earlymedia:
    ...
    sett_comment_prack:
      "100rel support. Should be enabled only if your server require this",
    sett_comment_short_prack: "",

    sett_display_name_ringtimeout: "Ring timeout",
    sett_comment_ringtimeout:
      "Maximum ringing time allowed in seconds. Default is 90 seconds",
    ...
    sett_comment_localip:
      "Optionally specify local signaling IP address to use",
    ...
    sett_comment_short_signalingport:
      "Optionally specify local signaling port to use",
    ...
    sett_comment_short_forcewifi:
      "Keep the WiFi awake to handle incoming calls",
    ...
    sett_display_name_callforwardonnoanswertimeout:
    ...
    sett_comment_callforwardalways:
    ...
    sett_comment_rejectonvoipbusy:
      "Set behavior if there is already a VoIP call in progress",
    sett_comment_short_rejectonvoipbusy: "",

    //TRANSLTSTART
    //OPSSTART
    sett_display_name_usetunneling: "Tunneling and encryption",
    sett_comment_usetunneling:
      "Use encrypted and tunneled transport layer (UDP, TCP or HTTP)",
    ...
    sett_comment_usetunneling_2:
      "Use signaling and media within encrypted tunnel.",
    //OPSEND
    //TRANSLTEND

    sett_display_name_encryptionport: "Encryption port",
    sett_comment_encryptionport:
      "Server base port used for encrypted transport",
    ...
    sett_comment_loglevel:
      "Save trace to file for later uploading to technical support",
    sett_comment_short_loglevel: "",
    ...
    sett_comment_aec:
      "Acoustic echo cancellation. Turn on if your peers hears their echo.",
    sett_comment_short_aec: "",

    sett_display_name_agc: "AGC",
    sett_comment_agc:
      "Automatic gain control. Will control the volume automatically.",
    ...
    sett_comment_call_access:
      "IVR access number to call from mobile operator network",
    sett_comment_short_call_access:
      "Access number to call from mobile operator network",

    sett_display_name_unlockphone: "Unlock keyguard",
    sett_comment_unlockphone:
      "Automatically unlock phone keyguard on incoming call",
    ...
    sett_comment_speakerphoneoutput:
      "Select the output device when you switch to speakerphone",
    ...
    sett_comment_short_codecframecount:
      "Number of codec payloads in one UDP packet",
    ...
    sett_comment_short_cfgcpuspeed:
    ...
    sett_comment_short_changesptoring:
      "Treat session progress (183) responses as ringing (180)",
    ...
    sett_comment_defmute:
      "Specify how to mute the calls when mute button is pressed",
    sett_comment_short_defmute: "",

    sett_display_name_incomingcallpopup: "Incoming call popup",
    sett_comment_incomingcallpopup:
      "Whether to display a popup about incoming calls.",
    sett_comment_short_incomingcallpopup: "",

    sett_display_name_automute: "Mute on new call",
    sett_comment_automute:
      "Specify whether existing calls should be muted on a new call",
    sett_comment_short_automute: "",

    sett_display_name_autohold: "Hold on new call",
    sett_comment_autohold:
      "Specify whether existing calls should be held on a new call",
    ...
    sett_comment_profilestatustext:
      "You can enter any text here (for example link to your facebook page).",
    ...
    sett_comment_short_audiobufferlength:
      "Advanced setting for the audio playback buffer size",
    ...
    sett_comment_short_displaynotification:
      "Show notifications in phone notification bar",

    sett_display_name_displayvolumecontrols: "Always display volume",
    sett_comment_displayvolumecontrols:
    ...
    sett_comment_short_cpualwayspartiallock:
    ...
    sett_comment_nativefilterblock:
      "Don't handle native calls if number starts with",
    sett_comment_short_nativefilterblock: "",

    sett_display_name_integrateifwifionly: "Integrate if Wifi only",
    sett_comment_integrateifwifionly:
      "Integrate with native dialer only if Wifi is connected",
    ...
    sett_comment_setfinalcodec:
      "Workaround for multiple codec negotiation issues",
    ...
    sett_comment_normalizenumber:
      "Remove special characters from dialed numbers",
    ...
    sett_comment_importonlywithnum:
      "If checked, then will skip contacts without a phone number",
    ...
    sett_comment_sscontrol:
      "Allow remote control for screen sharing (otherwise view only)",
    ...
    sett_comment_incomingcallpopup_hu:
      "Megjelenik-e egy felugró ablak a bejövő hívásoknál",
    sett_display_name_voicerecording_hu: "Hívásrögzítés",
    sett_comment_voicerecording_hu:
      "Ha engedélyezve van, minden hívás rögzítésre kerül",
    sett_display_name_keeprecfiles_hu: "Tartsa meg a felvételeket",
    sett_comment_keeprecfiles_hu:
      "Őrizze meg az utolsó megadott napok hívásfelvételeit",
    ...
    sett_comment_share_location_hu:
      "Megosztom a tartózkodási helyem adatait az ismerősökkel",
    ...
    callback_src_hu:
      "Ird be a mobilszámodat<br>(ország hivoszámát tartalmazva)",
    ...
    reset_settings_msg2_hu:
      "A beállitasok visszavoltak állitva az alapértékükre ",
    ...
    logview_help_hu:
      "Másold ki a logok ablak tartalmát és küld el emailben a következő cimre: ",
    ...
    contact_no_nunber_hu:
      "Irjál be egy telefonszámot, felhasználónevet vagy SIP URI-t",
    no_contacts_1_hu:
      "Kontaktok létrehozásához válaszd az “Uj kontakt”-ot a menüből",
    no_contacts_2_hu:
    ...
    clear_callhistory_msg_hu:
      "Biztos vagy benne, hogy akarod törölni a hiváslistát ?",
    ...
    np_popup_msg_hu:
      "Le kell töltsd a service plugin-t, hogy a softphone helyesen müködjön",
    ...
    hint_phone_number_hu:
      "Ird be a telefonszámot, SIP felhasználónevet vagy SIP URI-t",
    ...
    err_msg_3_hu:
      "ERROR, Ird be a telefonszámot vagy SIP URI-t vagy felhasználónevet",
    ...
    err_msg_22_hu:
      "Beállitások lekérdezése sikertelen. Később próbálkozz újra.",
    ...
    sett_comment_short_register_hu:
      "Kikapcsol / Bekapcsol regisztrálást a SIP domain-hez",

    sett_display_name_registerinterval_hu: "Regisztrálási időköz",
    sett_comment_registerinterval_hu:
      "Regisztrálási időköz másodpercekben kifejezve",
    sett_comment_short_registerinterval_hu: "",

    sett_display_name_earlymedia_hu: "Early media küldése",
    sett_comment_earlymedia_hu:
      "Média küldésének a kezdete, amikor megjön a session progres ",
    ...
    sett_comment_playring_hu:
      "Csengőhang generálása bejövő és kimenő hivásoknak",
    sett_comment_short_playring_hu: "",

    sett_display_name_autoanswer_forward_hu:
      "Automatikus hivásfogadás, továbbítás vagy lezárás",
    sett_comment_autoanswer_forward_hu:
      "Automatikusan kezeli a bejövő hivásokat",
    ...
    sett_comment_realm_hu:
      "Állitsd be a SIP realm-et, ha nem ugyanaz mint a VoIP szerver cime",
    ...
    sett_comment_short_use_stun_hu:
      "Publikus IP cim megtalálásának bekapcsolása",
    ...
    sett_comment_techprefix_hu:
      "Bármilyen tech prefix hozzáadása a hivott számhoz",
    ...
    sett_comment_ringtimeout_hu:
      "Maximális csörgési idő másodpercben. Alapértéke 90 másodperc",
    ...
    sett_comment_short_signalingport_hu:
      "Opcionálisan határozd meg a lokális signaling portot",
    ...
    sett_comment_short_forcewifi_hu:
      "Tartsd a wifi-t ébren, hogy müködjenek a bejövő hivások",
    ...
    sett_display_name_callforwardonreject_hu:
      "Hivástovábbitás visszautasitáskor",
    sett_comment_callforwardonreject_hu:
      "Továbbitsd a hivást ha vissza van utasitva",
...
*/
    ...
    sett_comment_filters_hu:
      "Hivott szám átirási szabalyok (hozzáad/töröl/prefix átirása)",
    sett_comment_short_filters_hu: "",

    sett_display_name_callback_mode_hu: "Callback metodus",
    sett_comment_callback_mode_hu:
      "Válaszd ki, hogy mikor használjon callback-et",
    sett_comment_short_callback_mode_hu: "",

    sett_display_name_email_hu: "Email cim",
    sett_comment_email_hu:
      "Az email cimed (hasznos a technikai ügyfélszolgálat számára)",
    ...
    sett_comment_savetocontacts_hu:
      "Ismeretlen számok automatikus hozzáadása a névjegyzékekhez",
    sett_comment_short_savetocontacts_hu:
      "Új kontaktok hozzáadása a névjegyzékekhez",
    ...
    sett_comment_unlockphone_hu:
      "Billentyüzár automatikus feloldása bejövő hivások esetén",
    ...
    sett_comment_speakerphoneoutput_hu:
      "Válaszd ki a kimeneteli eszközt kihangositás esetén",
    ...
    sett_comment_short_codecframecount_hu:
      "Kodek rakomány száma egy UDP csomagban",
    ...
    sett_comment_cfgnetworkspeed_hu:
      "Segit a legjobb kodek és médiafejlesztések kiválasztásában.",
    ...
    sett_comment_reset_settings_hu:
      "Beállítások visszaállítása az alapértékükre",
    sett_comment_short_reset_settings_hu: "",

    sett_display_name_autoignore_hu: "Automatikus figyelmenkivül hagyás",
    sett_comment_autoignore_hu:
      "Automatikusan figyelmenkivül hagyja a bejövő hivásokat ",
    sett_comment_short_autoignore_hu: "",

    sett_display_name_ringtone_hu: "Csengőhang",
    sett_comment_ringtone_hu:
      "Változtasd meg a csengőhangot a bejövő hivásoknak",
    ...
    sett_comment_short_changesptoring_hu:
      "A session progress(183) kezelése mint ringing (180)",
    ...
    sett_comment_enginepriority_ns_hu:
      "Állitsd be a service plugin prioritását",
    ...
    sett_comment_enginepriority_accessnum_hu:
      "Állitsd be az access number prioritását",
    sett_comment_short_enginepriority_accessnum_hu: "",

    sett_display_name_enginepriority_nativedial_hu: "Natív dialer prioritása",
    sett_comment_enginepriority_nativedial_hu:
      "Állitsd be a natív dialer prioritását",
    ...
    sett_display_name_settobasefunctionality_hu:
      "Alap funkcionalitás beállitása",
    ...
    sett_comment_displayvolumecontrols_hu:
      "Hangerő kontrolok állandó megjelenitése hivás alatt",
    sett_comment_short_displayvolumecontrols_hu: "",

    sett_display_name_displayaudiodevice_hu:
      "Audió készülék állandó megjelenitése",
    sett_comment_displayaudiodevice_hu:
      "Audió készülék állandó megjelenitése hivás alatt",
    ...
    sett_comment_short_cpualwayspartiallock_hu:
      "CPU állandó parciális lezárása",

    sett_display_name_disablewbforpstn_hu:
      "Szélessávú kodekek letiltása PSTN-re",
    ...
    sett_comment_storecallhistory_hu:
      "Határozd meg, hogy hová tárolja a hiváslistát",
    sett_comment_short_storecallhistory_hu: "",

    sett_display_name_keepdeviceawakeincall_hu:
      "Készülék ébren tartása hivás közben",
    sett_comment_keepdeviceawakeincall_hu:
      "Készülék ébren tartása hivás közben",
    ...
    sett_comment_short_hardwaremedia_hu:
      "Használjon hardware média fejlesztéseket",
    ...
    sett_comment_video_fps_hu:
      "Video frameráta állitása, 0 automatikusat jelent",
    sett_comment_short_video_fps_hu: "",

    sett_display_name_setfinalcodec_hu: "Végső kodek állitása",
    sett_comment_setfinalcodec_hu:
      "Megoldás többszörös kodek egyeztetési problémákra",
    ...
    sett_comment_submenu_calldivert_hu:
      "Hívásátirányítás, transzfer, számátirás",
    ...
    phone_hu: "Telefon",
    choose_engine_title_single_engine_hu:
      "Letöltéshez/instaláláshoz klikkelj rá",
    ...
    sett_comment_autoaccept_hu:
      "Automatikusan elfogadja az összes bejövo hivást",
    ...
    sett_comment_normalizenumber_hu:
      "Speciális karaktereknek az eltüntetése a hivott számbol",
    ...
    ce_alert_user_hu:
      "fel kell legyen instalálva, hogy a [BRAND] müködjön helyesen.",
    ...
    password_err_hu:
      "A jelszó tartalmaz nem támogatott speciális karaktereket, kérlek ird át",
    ...
    composing_hu: "ír",
    logview_msg_hu:
      "Az oldal nem elérheto pár másodpercig. Töltsd újra, ha semmi sem történik.",
    messagepl_hu: "Összeállítás",
    unlockadvancedsett_title_hu: "Beállitások engedélyezése",
    unlockadvancedsett_msg_hu:
      "Az elorehaladott beállitások engedélyezéséhez ird be a jelszót",
    warning_notreg_hu:
      "Nem tudsz hivást kezdeményezni, mert nem vagy beregisztrálva",
    warning_notstarted_hu:
      "Nem tudsz hivást kezdeményezni, mert a telefon még nincs elindulva",
    ...
    agc__both_for_recording_and_playback_hu:
      "A felvételhez és visszajátszáshoz",
    agc__guess_hu: "Kitalál",
    use_fast_ice__no_hu:
      "Nem (csak ha a szerver mindig kell route-olja a médiát)",
    ...
    changesptoring__start_media_disp_hu:
      "Médiát indít és megjelenít csőrgő státuszt",
    playring__no_hu: "Nem",
    ...
    callback_src_pt:
      "Digite seu número de telefone móvel <br> (começando com o código do país)",
    ...
    logview_help_pt:
      "Copiar o conteúdo da janela de registros e enviá-lo em um e-mail a:",
    ...
    contact_no_nunber_pt:
      "Introduza um número de telefone, nome de usuário ou URI",
    ...
    clear_callhistory_msg_pt:
      "Tem certeza de que deseja limpar todo o histórico de chamadas?",
    ...
    serviceengine_msg_pt:
      "Instalar plug-in de serviço para uma melhor experiência",
    ...
    ce_installnativeplugin_pt:
      "Instalar [NATIVE_PLUGIN] para a melhor experiência",
    ...
    hint_phone_number_pt:
      "Digite aqui o número de telefone, nome de usuário ou URI",
    ...
    filter_warning_pt:
      'Ao menos um dos campos "Comece com" ou "Substituir por" deve ser inserido',
    ...
    ce_alert_user_pt:
      "Deve ser instalado para [BRAND] para funcionar corretamente",
    ...
    username_err_pt:
      "O nome de usuário contém caracteres especiais, por favor reescreva",
    ...
    usenative_option_native_pt:
      "Recomendado: discador nativo com melhor qualidade",
    usenative_option_webrtc_pt:
      "Ignorar e começar (WebRTC) no navegador web agora",
    ...
    unlockadvancedsett_msg_pt:
      "Digite a senha para desbloquear as configurações avançadas",
    warning_notreg_pt:
      "Não pode iniciar a chamada porque ainda não está registrado",
    warning_notstarted_pt:
      "Não pode iniciar a chamada porque ainda não está registrado",
    ...
    err_msg_3_pt:
      "ERRO, digite um número de telefone ou SIP URI ou nome de usuário",
    ...
    sett_comment_serveraddress_user_pt:
      "Digite endereço do servidor (domínio ou IP: port)",
    ...
    sett_comment_sipusername_pt:
      "Seu nome de usuário SIP usado para autenticação",
    ...
    sett_comment_short_register_pt:
      "Habilitar o registro / desativar a SIP domínio",

    sett_display_name_registerinterval_pt: "Intervalo de registro",
    sett_comment_registerinterval_pt:
      "(Re) Registar intervalo de tempo em segundos",
    ...
    sett_comment_playring_pt:
      "Gerar toque para chamadas recebidas e efectuadas",
    ...
    sett_comment_short_voicemailnum_pt:
      "Definir número de acesso do correio de voz",
    ...
    sett_comment_techprefix_pt:
      "Adicionar qualquer prefixo para todos os números chamados",
    ...
    sett_comment_prack_pt:
      "Apoio 100% só deve ser ativado se o servidor precisar deste",
    ...
    sett_comment_short_forcewifi_pt:
      "Mantenha o WiFi ativo para lidar com as chamadas recebidas",
    ...
    sett_comment_autoignore_pt:
      "Automtically ignorar todas as chamadas recebidas",
    ...
    sett_display_name_callforwardonreject_pt:
      "Chamada para a frente em rejeitar",
    sett_comment_callforwardonreject_pt:
      "reencaminhamento de chamadas em caso de rejeição",
    ...
    sett_comment_short_usetunneling_pt:
      "Utilize os transportes criptografados alternativa",
    ...
    sett_comment_encryptionport_pt:
      "Porta base do servidor usado para o transporte criptografado",
...
*/
    ...
    sett_comment_loglevel_dbg_pt:
      "Definir log nível de detalhe quando os logs são habilitados",
    ...
    sett_comment_short_proximitysensor_pt:
      "Desligue a tela quando perto da orelha",

    sett_display_name_aec_pt: "AEC",
    sett_comment_aec_pt:
      "Cancelamento do Eco acústico. Ligue se os seus pares ouve o seu eco",
    sett_comment_short_aec_pt: "",

    sett_display_name_agc_pt: "AGC",
    sett_comment_agc_pt:
      "Controle automático de ganho. Irá controlar o volume automaticamente",
    ...
    sett_comment_email_pt:
      "O seu endereço de e-mail (útil para qualquer suporte técnico)",
    ...
    sett_comment_short_savetocontacts_pt:
      "Adicionar novos contatos à lista de contatos",

    sett_display_name_call_access_pt: "Número de acesso de chamada",
    sett_comment_call_access_pt:
      "Número de acesso IVR para ligar de rede do operador móvel",
    sett_comment_short_call_access_pt:
      "Número de acesso para ligar de rede do operador móvel",
    ...
    sett_comment_short_codecframecount_pt:
      "Número de payloads codec em um pacote UDP",
    ...
    sett_comment_short_extraoption_pt:
      "Definir quaisquer parâmetros personalizados",

    sett_display_name_reset_settings_pt: "Redefinir configurações",
    sett_comment_reset_settings_pt:
      "Redefinir as configurações para seus valores padrão",
    ...
    sett_comment_enginepriority_java_pt:
      "Definir java prioridade motor miniaplicativo",
    ...
    sett_comment_enginepriority_ns_pt:
      "Service Set prioridade motor de plug-in",
    sett_comment_short_enginepriority_ns_pt: "",

    sett_display_name_enginepriority_flash_pt: "Prioridade do Flash",
    sett_comment_enginepriority_flash_pt:
      "Definir a prioridade do motor de flash",
    ...
    sett_comment_enginepriority_p2p_pt:
      "Definir telefone a prioridade motor de telefone",
    sett_comment_short_enginepriority_p2p_pt: "",

    sett_display_name_enginepriority_accessnum_pt: "Acesso prioridade número",
    sett_comment_enginepriority_accessnum_pt:
      "Definir acesso prioritário motor de número",
    sett_comment_short_enginepriority_accessnum_pt: "",

    sett_display_name_enginepriority_nativedial_pt:
      "Prioridade discador nativo",
    sett_comment_enginepriority_nativedial_pt:
      "Definir a prioridade do motor discador nativo",
    ...
    sett_display_name_settobasefunctionality_pt:
      "Definido como funcionalidade básica",
    ...
    sett_comment_displayvolumecontrols_pt:
      "Sempre exibir controles de volume durante uma chamada",
    sett_comment_short_displayvolumecontrols_pt: "",

    sett_display_name_displayaudiodevice_pt:
      "Sempre exibir dispositivo de áudio",
    sett_comment_displayaudiodevice_pt:
      "Sempre exibir dispositivo de áudio durante uma chamada",
    ...
    sett_comment_short_callbacknumber_pt:
      "Número de acesso de retorno de chamada",
    ...
    sett_display_name_storecallhistory_pt:
      "Armazenamento de histórico de chamadas",
    sett_comment_storecallhistory_pt:
      "Especificar onde armazenar o histórico de chamadas",
    sett_comment_short_storecallhistory_pt: "",

    sett_display_name_keepdeviceawakeincall_pt:
      "Manter o dispositivo incall acordado",
    sett_comment_keepdeviceawakeincall_pt:
      "Manter o dispositivo acordado durante as chamadas",
    ...
    sett_comment_autousebluetooth_pt:
      "Uso Auto Bluetooth quando estiver disponível",
    sett_comment_short_autousebluetooth_pt: "",

    sett_display_name_nativefilterallow_pt: "Prefixos permitidos",
    sett_comment_nativefilterallow_pt:
      "Lidar com as chamadas nativas se o número começa com",
    ...
    sett_comment_video_fps_pt:
      "Definir vídeo framerate, 0 significa automática",
    sett_comment_short_video_fps_pt: "",

    sett_display_name_setfinalcodec_pt: "Definir codec finais",
    sett_comment_setfinalcodec_pt:
      "Solução para problemas de negociação múltiplos codecs",
    ...
    sett_comment_normalizenumber_pt:
      "Remover caracteres especiais de números discados",
    ...
    sett_comment_sendchatonenter_pt:
      "Enviar bate-papo em entrar pressione a tecla",
    ...
    callback_src_de:
      "Geben Sie Ihre Handynummer ein<br>(inkl. der Laendervorwahl)",
    ...
    reset_settings_msg_de:
      "Sind Sie sicher, dass Sie die Einstellungen zuruecksetzen wollen?",
    reset_settings_msg2_de:
      "Die Einstellungen wurden auf die Standardwerte zurueckgesetzt.",
    ...
    contact_save_error_de:
      "Fehler - Kontakt(e) können nicht gespeichert werden.",
    contact_no_nunber_de: "Geben Sie eine Rufnummer oder Benutzernamen an",
    no_contacts_1_de:
      "So erstellen Sie Kontakte: Neuer Kontakt aus dem Menue auswaehlen.",
    no_contacts_2_de:
    ...
    sync_message_de:
      "Sync funktioniert nur, nachdem Sie Kontakte aus mobilen Gerät geladen haben.",
    no_history_de: "Anrufliste leer",
    duration_de: "Gespraechsdauer:",
    rating_minute_de: " \\ min",
    clear_callhistory_de: "Anrufliste leeren",
    clear_callhistory_msg_de:
      "Sind Sie sicher dass Sie die Anrufliste loeschen wollen?",
    contact_delete_msg_de:
      "Sind Sie sicher dass Sie diesen Kontakt loeschen wollen?",
    ...
    serviceengine_msg_de:
      "Installiere service Plugin fuer eine bessere Erfahrung",
    np_download_de: "Service Plugin Download",
    np_popup_title_de: "Service Plugin",
    np_popup_msg_de:
      "Sie müssen das Service -Plugin installieren fuer das Softphone.",
    ...
    ce_installnativeplugin_de:
      "Installieren Sie [NATIVE_PLUGIN] fuer die beste Erfahrung",
    ...
    ce_alert_user_de:
      "muss installiert sein fuer [BRAND] damit das funktioniert.",
    ...
    password_err_de:
      "Das Passwort enthaelt nicht unterstuetzte Sonderzeichen, bitte umschreiben",
    ...
    usenative_option_native_de:
      "Empfohlen: nativen Dialer mit besserer Qualitaet",
    usenative_option_webrtc_de:
      "Ignorieren und ( WebRTC ) in Web-Browser jetzt starten",
    ...
    warning_notstarted_de:
      "Kann Anruf nicht initiieren, da das Softphone noch nicht gestartet ist",
    ...
    err_msg_3_de:
      "ERROR, Geben Sie eine Telefonnummer, SIP, URI oder Benutzername ein",
    ...
    err_msg_22_de:
      "Konfiguration nicht verfuehgbar, versuchen Sie es spaeter nochmals",
    ...
    agc__both_for_recording_and_playback_de:
      "fuer beides aufzeichnen und abspielen",
    ...
    automute__other_line_de:
      "Auf der anderen Linie klicken Sie auf die Schaltflaeche",
    ...
    sett_comment_serveraddress_user_de:
      "Enter server adress (domain or IP:port), brand-name or op-code here",
    sett_comment_serveraddress_user_gmsdialer_de:
      "Geben Sie den Operator Code ein",
    sett_comment_short_serveraddress_user_de: "kurze Server Adresse",
    sett_comment_serveraddress_user_operator_de:
      "Geben Sie den Operator Code ein",

    sett_display_name_sipusername_de: "Benutzername",
    sett_comment_sipusername_de:
      "Ihr SIP-Benutzername wird fuer die Authentifizierung verwendet.",
    ...
    sett_comment_short_register_de:
      "Aktiviere / Deaktiviere der Registrierung zu SIP-Domain",

    sett_display_name_registerinterval_de: "Registerungs Interval",
    sett_comment_registerinterval_de:
      "(Re)Registerungszeit Interval in Sekunden",
    ...
    sett_comment_signalingport_de:
      "Specify local IP address signaling port to use (default is a stable port initialized with a random value. This has nothing to do with the server SIP port which is usually 5060)",
    sett_comment_short_signalingport_de:
      "Optionally specify local signaling port to use",
    ...
    sett_comment_forcewifi_de:
      "(Re)Enable and scan WiFi on startup, new call or connection lost (Even without this setting, WiFi will be the preferred when available)",
    sett_comment_short_forcewifi_de:
      "Keep the WiFi awake to handle incoming calls",
...
*/
    ...
    sett_comment_email_de:
      "Your email address (useful for any technical support)",
    ...
    sett_comment_call_access_de:
      "IVR access number to call from mobile operator network",
    sett_comment_short_call_access_de:
      "Access number to call from mobile operator network",

    sett_display_name_unlockphone_de: "Unlock keyguard",
    sett_comment_unlockphone_de:
      "Automatically unlock phone keyguard on incoming call",
    ...
    sett_comment_speakerphoneoutput_de:
      "Select the output device when you switch to speakerphone",
    ...
    sett_comment_codecframecount_de:
      "Number of codec payloads in one UDP/RTP packet. Higher values will require less bandwidth but more delays. Unusual values (above 4) can cause incompatibility with your provider.",
    sett_comment_short_codecframecount_de:
      "Number of codec payloads in one UDP packet",
    ...
    sett_comment_changesptoring_de:
      "Treat session progress (183) responses as ringing (180). This might be required if your service provider doesn't send ringing nor early media",
    sett_comment_short_changesptoring_de:
      "Treat session progress (183) responses as ringing (180)",
    ...
    sett_comment_enginepriority_accessnum_de:
      "Set access number engine priority",
    sett_comment_short_enginepriority_accessnum_de: "",

    sett_display_name_enginepriority_nativedial_de: "Native dialer priority",
    sett_comment_enginepriority_nativedial_de:
      "Set native dialer engine priority",
    ...
    sett_comment_audiobufferlength_de:
      "-1 means auto. Valid values are between 160 and 16000. Expert setting.",
    sett_comment_short_audiobufferlength_de:
      "Advanced setting for the audio playback buffer size",
    ...
    sett_comment_normalizenumber_de:
      "Remove special characters from dialed numbers",
    ...
    sett_display_name_submenu_sounddevicevolume_de:
    ...
    np_popup_msg_it:
      "È necessario installare il plugin per utilizzare il telefono.",
  ...
  function get(resName) {
    ...
    if (typeof lang === "undefined" || lang === null || lang.length < 1) {
      if (
        typeof StringResources[resName] !== "undefined" &&
        StringResources[resName] !== null
      ) {
    ...
    if (
      typeof StringResources[reslang] !== "undefined" &&
      StringResources[reslang] !== null &&
      StringResources[reslang].length > 0
    ) {
    ...
    if (
      typeof StringResources[resName] !== "undefined" &&
      StringResources[resName] !== null &&
      StringResources[resName].length > 0
    ) {
  ...
  function setlang(lan) {
    ...
    if (lan.length > 2) {
      ...
      else if (lan.indexOf("_") > 0)
        langshort = lan.substr(0, lan.indexOf("_"));
    ...
    if (lang.length > 0) {
      if (
        (typeof StringResources["menu_call_" + lang] !== "undefined" &&
          StringResources["menu_call_" + lang] !== null &&
          StringResources["menu_call_" + lang].length > 0) ||
        (typeof StringResources["btn_login_" + lang] !== "undefined" &&
          StringResources["btn_login_" + lang] !== null &&
          StringResources["btn_login_" + lang].length > 0)
      ) {
        //ok
      } else {
        lang = "";
    ...
    if (langshort.length > 0) {
      if (
        (typeof StringResources["menu_call_" + langshort] !== "undefined" &&
          StringResources["menu_call_" + langshort] !== null &&
          StringResources["menu_call_" + langshort].length > 0) ||
        (typeof StringResources["btn_login_" + langshort] !== "undefined" &&
          StringResources["btn_login_" + langshort] !== null &&
          StringResources["btn_login_" + langshort].length > 0)
      ) {
        if (lang.length < 1) {
          lang = langshort;
          langshort = "";
