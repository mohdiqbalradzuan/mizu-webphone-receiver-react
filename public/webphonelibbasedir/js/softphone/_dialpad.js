...
webphone_api._dialpad = (function () {
  ...
  webphone_api.onCallStateChange(
  ...
  function onCreate(event) {
    ...
    try {
      ...
      webphone_api.$("#nav_dp_contacts").on("click", function () {
        webphone_api.$.mobile.changePage("#page_contactslist", {
          transition: "none",
          role: "page",
        });
      });
      webphone_api.$("#nav_dp_callhistory").on("click", function () {
        webphone_api.$.mobile.changePage("#page_callhistorylist", {
          transition: "none",
          role: "page",
        });
      });
      ...
      webphone_api
        .$("#nav_dp_dialpad")
        .attr("title", webphone_api.stringres.get("hint_dialpad"));
      webphone_api
        .$("#nav_dp_contacts")
        .attr("title", webphone_api.stringres.get("hint_contacts"));
      webphone_api
        .$("#nav_dp_callhistory")
        .attr("title", webphone_api.stringres.get("hint_callhistory"));

      webphone_api
        .$("#status_dialpad")
        .attr("title", webphone_api.stringres.get("hint_status"));
      webphone_api
        .$("#curr_user_dialpad")
        .attr("title", webphone_api.stringres.get("hint_curr_user"));
      webphone_api
        .$(".img_encrypt")
        .attr("title", webphone_api.stringres.get("hint_encicon"));
      ...
      webphone_api
        .$("#phone_number")
        .attr("title", webphone_api.stringres.get("hint_phone_number"));

      webphone_api
        .$("#phone_number")
        .on("input", function () // input text on change listener
        {
          PhoneInputOnChange();
        });
      ...
      webphone_api.$("#btn_showhide_numpad").on("click", function () {
        try {
          ...
          webphone_api.common.PutToDebugLogException(
            2,
            "_dialpad: btn_showhide_numpad on click",
            err2,
          );
        }
      });
      webphone_api
        .$("#btn_showhide_numpad")
        .attr("title", webphone_api.stringres.get("hint_numpad"));

      webphone_api
        .$("#dialpad_list")
        .on("click", ".ch_anchor", function (event) {
          OnListItemClick(webphone_api.$(this).attr("id"));
        });

      webphone_api.$("#dialpad_list").on(
        "taphold",
        ".ch_anchor",
        function (
          event, // also show context menu
        ) {
      ...
      webphone_api.$("#btn_voicemail").on("click", function () {
        try {
          ...
          webphone_api.common.PutToDebugLogException(
            2,
            "_dialpad: btn_voicemail on click",
            err2,
          );
        }
      });
      ...
      webphone_api.$("#btn_call").on("click", function () {
        ...
        if (
          ...
          if (
            webphone_api.common.isNull(webphone_api.common.GetSipusername()) ||
            webphone_api.common.GetSipusername().length <= 0 ||
            webphone_api.common.isNull(
              webphone_api.common.GetParameter("password"),
            ) ||
            webphone_api.common.GetParameter("password").length <= 0
          ) {
        ...
        if (webphone_api.common.isNull(field)) {
          return;
        }
        ...
        if (webphone_api.common.isNull(phoneNumber) || phoneNumber.length < 1) {
          if (
            !webphone_api.common.isNull(lastDialed) &&
            lastDialed.length > 0
          ) {
            ...
            webphone_api.common.PutToDebugLog(
              1,
              webphone_api.stringres.get("err_msg_3"),
            );
            return;
          }
        } else {
      ...
      webphone_api
        .$("#btn_call")
        .attr("title", webphone_api.stringres.get("hint_btn_call"));
        ...
        try {
          ...
          if (charCode === 8) {
            ...
            if (webphone_api.$(".ui-page-active .ui-popup-active").length > 0) {
              ...
              if (
                !webphone_api.common.isNull(pop) &&
                (pop.attr("id") === "adialog_videocall" ||
                  pop.attr("id") === "adialog_screensharecall")
              ) {
                // initiate video call
      ...
      webphone_api
        .$("#btn_message")
        .attr("title", webphone_api.stringres.get("hint_message"));
      ...
      webphone_api
        .$("#dialpad_notification_list")
        .on("click", ".nt_anchor", function (event) {
          webphone_api.$("#dialpad_not").panel("close");
          webphone_api.common.NotificationOnClick2(
            webphone_api.$(this).attr("id"),
            false,
          );
        });
      webphone_api
        .$("#dialpad_notification_list")
        .on("click", ".nt_menu", function (event) {
          webphone_api.$("#dialpad_not").panel("close");
          webphone_api.common.NotificationOnClick2(
            webphone_api.$(this).attr("id"),
            true,
      ...
      webphone_api.$("#btn_dialpad_menu").on("click", function () {
        CreateOptionsMenu("#dialpad_menu_ul");
      });
      webphone_api
        .$("#btn_dialpad_menu")
      ...
      setTimeout(function () {
        ...
        if (
          webphone_api.common.GetParameterBool("customizedversion", true) !==
            true &&
          webphone_api.common.GetParameter("displaypopupdirectcalls") === "true"
        ) {
        ...
        if (displaypopup) {
          ...
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("warning_msg_1"),
            6000,
          );
        }
      }, 3000);
      ...
      webphone_api.$("#btn_backspace").on("taphold", function () {
        if (
          !webphone_api.common.isNull(document.getElementById("phone_number"))
        ) {
        ...
        webphone_api
          ...
          .attr(
            ...
            webphone_api.common.GetElementSource() +
              "images/btn_backspace_txt_grey.png",
          );
      }
      if (cthemeTmp === 22) {
        webphone_api
      ...
      setTimeout(function () {
        webphone_api.common.GetContacts(function (success) {
          if (!success) {
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, _dialpad: LoadContacts failed onCreate",
            );
          }
        });
      }, 500);
      ...
      setTimeout(function () {
        webphone_api.common.ReadCallhistoryFile(function (success) {
          if (!success) {
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, _dialpad: load call history failed onCreate",
            );
          }
        });
      }, 1000);
      ...
      if (webphone_api.common.UsePresence2() === true) {
        webphone_api
          .$("#dialpad_additional_header_left")
          .on("click", function () {
      ...
      if (
        webphone_api.common.isNull(srateStr) ||
        srateStr.length < 1 ||
        !webphone_api.common.IsNumber(srateStr)
      ) {
        srateStr = webphone_api.common.GetParameter2("showratewhiletype");
      }
      if (
        webphone_api.common.isNull(srateStr) ||
        srateStr.length < 1 ||
      ...
      webphone_api.global.showratewhiletype_cache =
        webphone_api.common.StrToInt(srateStr);

      if (
        webphone_api.global.showratewhiletype_cache > 0 &&
        !webphone_api.common.isNull(
          document.getElementById("disprate_container"),
        ) &&
        webphone_api.common.GetParameter("ratingrequest").length > 0
      ) {
      ...
      webphone_api.$("#btn_dialpad_engine").on("click", function (event) {
        ...
        if (chooseenginetouse === "java") {
          ...
          webphone_api.common.EngineSelect(1, 26);
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: onCreate", err);
    }
  }
  ...
  function PutNumber(val) {
    try {
      ...
      if (webphone_api.$("#phone_number").is(":focus")) {
        // don't write any characters, if input is focused
        return;
      }

      if (webphone_api.common.isNull(nrfield)) {
        return;
      }

      if (webphone_api.common.isNull(nrfield.value)) {
        nrfield.value = "";
      }
      ...
      if (webphone_api.common.isNull(nrval)) {
        nrval = "";
      }
      ...
      nrval = webphone_api.common.ReplaceAll(nrval, "#", "");
      if (
        !webphone_api.common.isNull(val) &&
        webphone_api.common.IsNumber(val) &&
        webphone_api.common.IsNumber(nrval)
      ) {
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: PutNumber", err);
    }
  }

  function PutCharLongpress(carr) {
    // handle dialpad long press (taphold)
    try {
      var nrfield = document.getElementById("phone_number");
      if (webphone_api.common.isNull(nrfield)) {
        return;
      ...
      if (webphone_api.common.isNull(carr) || carr.length < 1) {
        return;
      }
  ...
  function PhoneInputOnChange() {
    try {
      ...
      if (
        webphone_api.common.isNull(field) ||
        webphone_api.common.isNull(field.value)
      ) {
        return;
      }
      ...
      if (nrval.length > 0) {
        ...
        webphone_api
          .$("#phone_number_container .ui-input-text")
          .css("text-align", "center");
        webphone_api
          .$("#phone_number_container .ui-input-text:focus")
          .css("text-align", "center");
      } else {
      ...
      if (
        issearch &&
        nrval.length > 0 &&
        !webphone_api.common.isNull(webphone_api.global.ctlist) &&
        webphone_api.global.ctlist.length > 0
      ) {
      ...
      if (dialpadvisible) {
        // if dialpad was visible, then dn't hide it after PopulateList
        webphone_api.$("#dialpad_btn_grid").show();
        MeasureDialPad();
      }
      ...
      if (
        ...
        if (showratewhiletype_minlenth < 0) {
          var srmin = webphone_api.common.GetParameter2(
            "showratewhiletype_minlenth",
          );
          if (
            !webphone_api.common.isNull(srmin) &&
            webphone_api.common.IsNumber(srmin)
          ) {
            showratewhiletype_minlenth = webphone_api.common.StrToInt(srmin);
          } else {
            showratewhiletype_minlenth = 3;
          }
          var srmax = webphone_api.common.GetParameter2(
            "showratewhiletype_maxlenth",
          );
          if (
            !webphone_api.common.isNull(srmax) &&
            webphone_api.common.IsNumber(srmax)
          ) {
        ...
        if (
          nrval.length >= showratewhiletype_minlenth &&
          nrval.length <= showratewhiletype_maxlenth
        ) {
          webphone_api.common.UriParser(
            webphone_api.common.GetParameter("ratingrequest"),
            "",
            nrval,
            "",
            "",
  ...
  function StartCall(number, isvideo) {
    try {
      if (webphone_api.common.isNull(number) || number.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, _dialpad: StartCall number is NULL",
        );
        return;
      }
      ...
      if (isvideo === true) {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _dialpad initiate video call to: " + number,
        );
        webphone_api.videocall(number);
      } else {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _dialpad initiate call to: " + number,
        );
        webphone_api.call(number, -1);
      }
    } catch (err) {
      webphone_api.common.PutToDebugLogException(2, "_dialpad: StartCall", err);
    }
  }
  ...
  function QuickCall() {
    try {
      ...
      var template =
        "" +
        '<div id="quickcall_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        ...
        webphone_api.stringres.get("quickcall_title") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content">' +
        "<span>" +
        webphone_api.stringres.get("quickcall_msg") +
        "</span>" +
        ...
        webphone_api.stringres.get("btn_quickcall") +
        "</a>" +
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api
          ...
          .on("popupafterclose", function (event) {
            webphone_api.common.PutToDebugLog(
              5,
              "EVENT, _dialpad SetVoiceMailNumber OK click",
            );
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: QuickCall", err);
    }
  }
  ...
  function onStart(event) {
    ...
    try {
      ...
      if (webphone_api.global.pagewasrefreshed === true) {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _dialpad: onStart page refresh detected, go back to settings page",
        );
      ...
      webphone_api
        .$("#phone_number")
        .attr("placeholder", webphone_api.stringres.get("phone_nr"));
      //BRANDSTART
      if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
        // favafone
        webphone_api
          .$("#phone_number")
          .attr("placeholder", webphone_api.stringres.get("phone_nr2"));
      } else if (webphone_api.common.GetConfigInt("brandid", -1) === 60) {
        // voipmuch
        webphone_api
          .$("#phone_number")
          .attr("placeholder", "Enter # or Contact Name");
        webphone_api
          .$("#phone_number_container .ui-input-text")
          .css("font-size", "1.2em");
        webphone_api
      ...
      if (webphone_api.common.GetColortheme() === 22) {
        webphone_api
          .$("#nav_dp_dialpad IMG")
          .attr("src", "images/tab_dialpad_blue.png");
        webphone_api
          .$("#nav_dp_contacts IMG")
          .attr("src", "images/tab_contacts_grey.png");
        webphone_api
          .$("#nav_dp_callhistory IMG")
          .attr("src", "images/tab_callog_grey.png");
      }

      if (
        !webphone_api.common.isNull(
          document.getElementById("app_name_dialpad"),
        ) &&
        webphone_api.common.GetParameter("devicetype") !==
          webphone_api.common.DEVICE_WIN_SOFTPHONE()
      ) {
        document.getElementById("app_name_dialpad").innerHTML =
          webphone_api.common.GetBrandName();
      }

      if (
        !webphone_api.common.isNull(document.getElementById("dialpad_title"))
      ) {
        document.getElementById("dialpad_title").innerHTML =
          webphone_api.stringres.get("dialpad_title");
      }
      webphone_api
        .$("#dialpad_title")
      ...
      if (
        !webphone_api.common.isNull(curruser) &&
        curruser.length > 0 &&
        curruser != webphone_api.$("#curr_user_dialpad").html()
      ) {
        webphone_api.$("#curr_user_dialpad").html(curruser);
      }
      /*
// set status width so it's uses all space to curr_user
    ...
    */
      ...
      if (webphone_api.common.GetParameterInt("voicemail", 2) !== 2) {
        webphone_api
          ...
          .attr(
            ...
            "" +
              webphone_api.common.GetElementSource() +
              "images/btn_call_quick_txt.png",
          );
        webphone_api
          .$("#btn_voicemail")
          .attr("title", webphone_api.stringres.get("hint_quickcall"));
      } else {
        webphone_api
          .$("#btn_voicemail_img")
          .attr(
      ...
      if (webphone_api.common.GetParameter("header").length > 2) {
        ...
        webphone_api
          .$("#headertext_settings")
          .html(webphone_api.common.GetParameter("header"));
      } else {
      ...
      if (webphone_api.common.GetParameter("footer").length > 2) {
        ...
        webphone_api
          .$("#footertext_dialpad")
          .html(webphone_api.common.GetParameter("footer"));
      } else {
      ...
      if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
        ...
        webphone_api
          ...
          .attr(
            ...
            "" +
              webphone_api.common.GetElementSource() +
              "images/icon_recharge_dollar.png",
          );
      }
      //BRANDEND
      ...
      if (
        (webphone_api.common.HideSettings(
          "chat",
          webphone_api.stringres.get("sett_display_name_" + "chat"),
          "chat",
          true,
        ) === true ||
          webphone_api.common.GetParameterInt("chatsms", 0) == 3 ||
          webphone_api.common.GetParameterInt("textmessaging", -1) == 0 ||
          webphone_api.common.GetParameterInt("textmessaging", -1) == 2) &&
        //BRANDSTART
      ...
      if (
        webphone_api.common.HideSettings(
          "voicemail",
          webphone_api.stringres.get("sett_display_name_" + "voicemail"),
          "voicemail",
          true,
        ) === true
      ) {
      ...
      if (webphone_api.common.GetConfigInt("brandid", -1) === 58) {
        ...
        if (!webphone_api.common.isNull(logodiv)) {
          ...
          if (!webphone_api.common.isNull(middle)) {
          ...
          logodiv.innerHTML =
            '<img src="' +
            webphone_api.common.GetElementSource() +
            'images/logo.png" style="border: 0;">&nbsp;&nbsp;&nbsp;<div class="adhead_custom_brand" style=""><b>eNikMa</b> Unified Comm</div>';
        }
      }
      //BRANDEND
      ...
      if (!webphone_api.common.isNull(custm_uri) || custm_uri.length > 3) {
        ...
        if (webphone_api.common.GetColortheme() === 22) {
          webphone_api
            .$("#btn_showhide_numpad_img")
            .attr(
              "src",
              webphone_api.common.GetElementSource() +
                "images/btn_numpad_txt_grey.png",
            );
        } else {
          webphone_api
            .$("#btn_showhide_numpad_img")
      ...
      if (webphone_api.common.IsIeVersion(10)) {
        webphone_api.$("#dialpad_list").children().css("line-height", "normal");
      }
      if (webphone_api.common.IsIeVersion(10)) {
        webphone_api
          .$("#dialpad_notification_list")
      ...
      webphone_api
        .$("#dialpad_notification_list")
        .height(webphone_api.common.GetDeviceHeight() - 55);
      lastoop = 11;
      ...
      if (
        !webphone_api.common.isNull(pnr) &&
  ...
  function GetCallhistory() {
    try {
      if (
        (webphone_api.common.isNull(webphone_api.global.chlist) ||
          webphone_api.global.chlist.length < 1) &&
        webphone_api.global.readcallhistoryforrecents
      ) {
        webphone_api.common.ReadCallhistoryFile(function (success) {
          if (!success) {
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, _dialpad: load call history failed (2) GetCallhistory",
            );
          }
          ...
          webphone_api.common.GetContacts(function (success) {
            if (!success) {
              if (webphone_api.common.CanLog(2)) {
                webphone_api.common.PutToDebugLog(
                  2,
                  "EVENT, _dialpad: LoadContacts failed GetCallhistory",
                );
              }
            }
          });
    ...
    try {
      if (
        ...
        (webphone_api.global.refreshrecents === false &&
          webphone_api.global.recentlist.length > 0)
      ) {
        return;
      }
      ...
      if (webphone_api.common.isNull(chtmp) || chtmp.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: GetRecents list is NULL",
        );
        return;
      }
      ...
      for (var i = 0; i < chtmp.length; i++) {
        if (webphone_api.common.isNull(chtmp[i])) {
          continue;
        }

        var item = chtmp[i];
        if (
          webphone_api.common.isNull(item[webphone_api.common.CH_NUMBER]) ||
          item[webphone_api.common.CH_NUMBER].length < 1
        ) {
          continue;
        }

        if (
          webphone_api.common.IsContactBlocked(
            item[webphone_api.common.CH_NUMBER],
            null,
          ) === true
        ) {
          continue;
        ...
        var dateint = 0;
        try {
          dateint = webphone_api.common.StrToInt(
            webphone_api.common.Trim(item[webphone_api.common.CH_DATE]),
          );
        } catch (errin1) {
          webphone_api.common.PutToDebugLogException(
            2,
            "_dialpad: GetRecents convert duration",
            errin1,
          );
        }
        ...
        if (enablepres) {
          var presence = "-1";
          var presobj =
            webphone_api.global.presenceHM[item[webphone_api.common.CH_NUMBER]];
          ...
          if (!webphone_api.common.isNull(presence)) {
            // available
            if (presence === "5") {
              points = points + IS_ONLINE;
            } else if (
              (presence === "0" || presence === "1" || presence === "4") &&
              points > 10
            ) {
          ...
          if (
            webphone_api.common.isNull(presence) ||
            presence.length < 1 ||
            presence === "-1"
          ) {
            if (webphone_api.common.isNull(presencequery)) {
              presencequery = [];
            }
            if (
              presencequery.indexOf(item[webphone_api.common.CH_NUMBER]) < 0
            ) {
        ...
        var ctid = webphone_api.common.GetContactIdFromNumber(
          item[webphone_api.common.CH_NUMBER],
        );
        if (ctid >= 0) {
          ...
          if (!webphone_api.common.isNull(ct)) {
            if (
              ct.length > webphone_api.common.CT_FAV &&
              ct[webphone_api.common.CT_FAV] === "1"
            ) {
              points = points * 1.15;
            }

            if (
              ct.length > webphone_api.common.CT_ISFROMSYNC &&
              ct[webphone_api.common.CT_ISFROMSYNC] === "0"
            ) {
              points = points * 1.1;
            }
          }
        ...
        for (var j = 0; j < rectmp.length; j++) {
          if (
            rectmp[j][webphone_api.common.RC_NUMBER] ===
            item[webphone_api.common.CH_NUMBER]
          ) {
            exists = j;
            break;
        ...
        var ctidtmp = webphone_api.common.GetContactIdFromNumber(
          item[webphone_api.common.CH_NUMBER],
        );
        if (
          !webphone_api.common.isNull(ctidtmp) &&
          webphone_api.common.IsNumber(ctidtmp)
        ) {
        ...
        if (exists >= 0) {
          ...
          try {
            ...
            if (typeof potmp !== "number") {
              pointstmp = webphone_api.common.StrToInt(
                webphone_api.common.Trim(
                  rectmp[exists][webphone_api.common.RC_RANK],
                ),
              );
            } else {
              pointstmp = potmp;
            ...
            webphone_api.common.PutToDebugLogException(
              2,
              "_dialpad: GetRecents convert points",
              errin2,
            );
          }
          ...
          entry[webphone_api.common.RC_TYPE] =
            item[webphone_api.common.CH_TYPE];
          entry[webphone_api.common.RC_NAME] =
            item[webphone_api.common.CH_NAME];
          entry[webphone_api.common.RC_NUMBER] =
            item[webphone_api.common.CH_NUMBER];
          entry[webphone_api.common.RC_DATE] =
            item[webphone_api.common.CH_DATE];
          entry[webphone_api.common.RC_RANK] = points;
          entry[webphone_api.common.RC_DURATION] =
            item[webphone_api.common.CH_DURATION];
      ...
      if (
        enablepres &&
        !webphone_api.common.isNull(presencequery) &&
        presencequery.length > 0
      ) {
        var ulist = "";
        for (var i = 0; i < presencequery.length; i++) {
          if (
            webphone_api.common.isNull(presencequery[i]) ||
            webphone_api.common.Trim(presencequery[i]).length < 1
          ) {
            continue;
          }
  ...
  function SortRecents() {
    try {
      webphone_api.global.recentlist.sort(
        function (
          a,
      ...
      PutToDebugLogException(2, "_dialpad: SortRecents", err);
    }
  }

  function PopulateListRecents() {
    // :no return value
    ...
    try {
      ...
      if (webphone_api.common.isNull(document.getElementById("dialpad_list"))) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: PopulateListRecents listelement is null",
        );
        return;
      }
      ...
      if (
        webphone_api.common.isNull(webphone_api.global.recentlist) ||
        webphone_api.global.recentlist.length < 1 ||
        webphone_api.common.HideSettings("recents", "", "recents", true) ===
          true
      ) {
        lastoop = 4;
        webphone_api.$("#dialpad_btn_grid").show();
        ...
        if (webphone_api.common.CanLog(2)) {
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT, _dialpad: PopulateListRecents no recents",
          );
        }
          ...
          if (webphone_api.common.GetColortheme() === 22) {
            webphone_api
              ...
              .attr(
                "src",
                webphone_api.common.GetElementSource() +
                  "images/btn_voicemail_txt_big_grey.png",
              );
          } else {
            webphone_api
              .$("#btn_showhide_numpad_img")
              .attr(
                ...
                "" +
                  webphone_api.common.GetElementSource() +
                  "images/btn_voicemail_txt_big.png",
              );
          }
          webphone_api
            .$("#btn_showhide_numpad")
      ...
      if (
        !webphone_api.common.isNull(webphone_api.global.recentlist) &&
        webphone_api.global.recentlist.length < itemstodisplay
      ) {
      ...
      for (var i = 0; i < itemstodisplay; i++) {
        if (
          webphone_api.global.recentlist[i][webphone_api.common.RC_NAME] ===
          webphone_api.global.recentlist[i][webphone_api.common.RC_NUMBER]
        ) {
          webphone_api.global.recentlist[i][webphone_api.common.RC_NAME] =
            webphone_api.common.GetContactNameFromNumber(
              webphone_api.global.recentlist[i][webphone_api.common.RC_NUMBER],
            );
        } else {
          var idtemp = webphone_api.common.GetContactIdFromNumber(
            webphone_api.global.recentlist[i][webphone_api.common.RC_NUMBER],
          );
          if (idtemp < 0) {
            ...
            webphone_api.global.recentlist[i][webphone_api.common.RC_NAME] =
              webphone_api.common.GetContactNameFromNumber(
                webphone_api.global.recentlist[i][
                  webphone_api.common.RC_NUMBER
                ],
              );
          }
        }
      ...
      if (webphone_api.common.CanLog(2)) {
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, _dialpad Starting populate recents list",
        );
      }
      var recent_menu =
        '<a id="recentmenu_[RCID]" class="ch_menu mlistitem">' +
        webphone_api.stringres.get("hint_recents") +
        "</a>";
      ...
      for (var i = 0; i < itemstodisplay; i++) {
        ...
        if (webphone_api.common.isNull(item) || item.length < 1) {
          continue;
        }
        ...
        var durationint = 0;
        try {
          durationint = webphone_api.common.StrToInt(
            webphone_api.common.Trim(item[webphone_api.common.RC_DURATION]),
          );
        } catch (errin1) {
          webphone_api.common.PutToDebugLogException(
            2,
            "_dialpad: PopulateListRecents convert duration",
            errin1,
          );
        }
        ...
        if (item[webphone_api.common.RC_TYPE] === "1") {
          icon = "icon_call_incoming";
        }

        var datecallint = 0;
        try {
          datecallint = webphone_api.common.StrToInt(
            webphone_api.common.Trim(item[webphone_api.common.RC_DATE]),
          );
        } catch (errin1) {
          webphone_api.common.PutToDebugLogException(
            2,
            "_dialpad: PopulateListRecents convert date of call",
            errin1,
          );
        }
        ...
        if (
          item[webphone_api.common.RC_NAME] ===
          item[webphone_api.common.RC_NUMBER]
        ) {
          lisitem = lisitem.replace(
            "[NUMBERONLY]",
            item[webphone_api.common.RC_NUMBER],
          );
        ...
        if (enablepres) {
          ...
          if (webphone_api.common.isNull(presence) || presence.length < 1) {
            ...
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_grey.png" />';
          } else if (presence === "1") {
            // invisible
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_white.png" />';
          } else if (presence === "2") {
            // idle
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_yellow.png" />';
          } else if (presence === "3") {
            // pending
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_orange.png" />';
          } else if (presence === "4") {
            // DND
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_red.png" />';
          } else if (presence === "5") {
            // online
            presenceimg =
              '<img src="' +
              webphone_api.common.GetElementSource() +
              'images/presence_green.png" />';
          } else {
            presenceimg = "";
          }
        }
      ...
      if (
        ...
        if (
          !webphone_api.common.isNull(liheight) &&
          webphone_api.common.IsNumber(liheight) &&
          webphone_api.$("#dialpad_btn_grid").is(":visible")
        ) {
          webphone_api.$("#dialpad_btn_grid .ui-btn").height("auto");

          var count = webphone_api.global.nrofrecentstodisplay;
          if (count > webphone_api.global.recentlist.length) {
            count = webphone_api.global.recentlist.length;
          }
          var listheight = count * liheight;

          var availablespace =
            webphone_api.common.GetDeviceHeight() -
            webphone_api.$("#dialpad_header").height() -
            webphone_api.$("#phone_number_container").height() -
            webphone_api.$("#dialpad_footer").height() -
            webphone_api.common.StrToIntPx(
              webphone_api.$("#dialpad_header").css("border-top-width"),
            ) -
            webphone_api.common.StrToIntPx(
              webphone_api.$("#dialpad_header").css("border-bottom-width"),
            ) -
            2 * webphone_api.$(".separator_color_bg").height();

          availablespace =
            availablespace - webphone_api.$("#dialpad_btn_grid").height();
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_dialpad: PopulateListRecents " + lastoop,
        err,
      );
    }
  }

  function PopulateListContacts(nrval) {
    // :no return value
    try {
      ...
      if (webphone_api.common.isNull(document.getElementById("dialpad_list"))) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: PopulateListContacts listelement is null",
        );
        return;
      }
      ...
      webphone_api.common.PutToDebugLog(
        2,
        "EVENT, _dialpad Starting populate searched contact list",
      );
      ...
      for (var i = 0; i < webphone_api.global.searchctlist.length; i++) {
        if (
          webphone_api.common.isNull(webphone_api.global.searchctlist[i]) ||
          webphone_api.global.searchctlist[i].length < 1
        ) {
          continue;
        }
        ...
        lisitem = lisitem.replace(
          "[NAME]",
          webphone_api.global.searchctlist[i][webphone_api.common.CT_NAME],
        );
        lisitem = lisitem.replace(
          "[NUMBER]",
          webphone_api.global.searchctlist[i][webphone_api.common.CT_NUMBER],
        );
  ...
  function SearchContacts(searchval) {
    try {
      if (
        webphone_api.common.isNull(searchval) ||
        webphone_api.common.Trim(searchval).lengh < 1
      ) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: SearchContacts value is NULL",
        );
        return;
      }
      ...
      for (var i = 0; i < webphone_api.global.ctlist.length; i++) {
        ...
        if (
          ctTemp[webphone_api.common.CT_NAME]
            .toLowerCase()
            .indexOf(searchval) >= 0
        ) {
          add = true;
          ...
          for (
            var j = 0;
            j < ctTemp[webphone_api.common.CT_NUMBER].length;
            j++
          ) {
            ...
            entry[webphone_api.common.CT_NUMBER] =
              ctTemp[webphone_api.common.CT_NUMBER][j];
        ...
        if (
          add === false &&
          !webphone_api.common.isNull(ctTemp[webphone_api.common.CT_NUMBER])
        ) {
          for (
            var j = 0;
            j < ctTemp[webphone_api.common.CT_NUMBER].length;
  ...
  function OnListItemClick(id, islongclick) {
    // :no return value
    try {
      if (trigerredlist) {
        return;
      ...
      if (webphone_api.common.isNull(id) || id.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad OnListItemClick id is NULL",
        );
        return;
      }
      ...
      if (pos < 2) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad OnListItemClick invalid id",
        );
        return;
      }
      ...
      try {
        ...
        webphone_api.common.PutToDebugLogException(
          2,
          "_dialpad: OnListItemClick convert rcid",
          errin1,
        );
      }

      if (id.indexOf("recentitem") === 0) {
        // means call from recents list
        var to =
          webphone_api.global.recentlist[idint][webphone_api.common.RC_NUMBER];
        var name =
          webphone_api.global.recentlist[idint][webphone_api.common.RC_NAME];

        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, _dialpad recents call to: " + to,
        );
        webphone_api.call(to, -1);
      } else if (id.indexOf("recentmenu") === 0) {
        // menu from recents list
        RecentMenu(idint, true, islongclick);
      } else if (id.indexOf("searcheditem") === 0) {
        // means call from recents list
        if (islongclick === true) {
          ...
          var name =
            webphone_api.global.searchctlist[idint][
              webphone_api.common.CT_NAME
            ];

          webphone_api.common.PutToDebugLog(
            2,
            "EVENT, _dialpad searched item call to: " + to,
          );
          webphone_api.call(to, -1);
        }
      } else if (id.indexOf("searchedmenu") === 0) {
        // menu from recents list
        RecentMenu(idint, false, islongclick);
      }
    } catch (err) {
  ...
  function RecentMenu(rcid, isrecent, islongclick, popupafterclose) {
    try {
      if (
        webphone_api.common.isNull(rcid) ||
        rcid.length < 1 ||
        rcid < 0 ||
        rcid > webphone_api.global.recentlist.length
      ) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, RecentMenu: invalid id: " + rcid,
        );
        return;
      }
      ...
      if (isrecent) {
        rcname =
          webphone_api.global.recentlist[rcid][webphone_api.common.RC_NAME];
        rcnumber =
          webphone_api.global.recentlist[rcid][webphone_api.common.RC_NUMBER];
      } else {
        rcname =
          webphone_api.global.searchctlist[rcid][webphone_api.common.CT_NAME];
        rcnumber = webphone_api.$("#ch_ctnumber_" + rcid).html();
      }

      if (webphone_api.common.isNull(rcname)) {
        rcname = "";
      }
      if (webphone_api.common.isNull(rcnumber)) {
        rcnumber = "";
      }

      if (webphone_api.common.GetContactIdFromNumber(rcnumber) >= 0) {
        // if contact exists
        // show context menu instead
        if (islongclick === true) {
          CreateContextmenu(
            webphone_api.common.GetContactIdFromNumber(rcnumber),
            rcname,
            rcnumber,
            popupafterclose,
          );
        } else {
          webphone_api.global.intentctdetails[0] =
            "ctid=" + webphone_api.common.GetContactIdFromNumber(rcnumber);
          webphone_api.global.intentctdetails[1] = "frompage=dialpad";
          webphone_api.$.mobile.changePage("#page_contactdetails", {
            transition: "none",
            role: "page",
          });
        }
  ...
  function CreateContextmenu(cid_in, cname, cnr, popupafterclose) {
    try {
      if (
        webphone_api.common.isNull(cid_in) ||
        cid_in.length < 1 ||
        !webphone_api.common.IsNumber(cid_in)
      ) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: CreateContextmenu invalid contact id: " + cid_in,
        );
      }
      ...
      if (iscontact === true) {
        isfavorite = webphone_api.common.ContactIsFavorite(cid);
      }
      ...
      if (iscontact === true) {
        ...
        itemTemp = itemTemp.replace(
          "[ITEMTITLE]",
          webphone_api.stringres.get("menu_editcontact"),
        );
        list = list + itemTemp;
        itemTemp = "";
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("menu_call"),
      );
      list = list + itemTemp;
      itemTemp = "";
      ...
      if (webphone_api.common.CanIUseVideo() === true) {
        ...
        itemTemp = itemTemp.replace(
          "[ITEMTITLE]",
          webphone_api.stringres.get("btn_videocall"),
        );
        list = list + itemTemp;
        itemTemp = "";
      }
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("send_msg"),
      );
      list = list + itemTemp;
      itemTemp = "";

      if (
        webphone_api.common.GetConfigBool("hasfiletransfer", true) !== false &&
        webphone_api.common.IsMizuServerOrGateway()
      ) {
        //OPSSTART
        if (webphone_api.common.Glft() === true) {
          ...
          itemTemp = itemTemp.replace(
            "[ITEMTITLE]",
            webphone_api.stringres.get("filetransf_title"),
          );
          list = list + itemTemp;
          itemTemp = "";
          //OPSSTART
      ...
      if (iscontact === true) {
        ...
        if (isfavorite === true) {
          favtitle = webphone_api.stringres.get("menu_ct_unsetfavorite");
        }
      ...
      var title = cname;
      if (webphone_api.common.isNull(title) || title.length < 1) {
        title = cnr;
      }

      var template =
        "" +
        '<div id="dp_contextmenu" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        "px; min-width: " +
        ...
        "</div>" +
        '<div data-role="footer" data-theme="b" class="adialog_footer">' +
        '<a href="javascript:;" style="width: 98%;" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back" data-transition="flow">' +
        webphone_api.stringres.get("btn_close") +
        "</a>" +
        "</div>" +
        "</div>";
          ...
          .on("popupafterclose", function (event) {
            ...
            if (itemid === "#dp_item_edit_contact") {
              ...
              if (isfavorite === true) {
                ...
                webphone_api.common.ShowToast(
                  webphone_api.stringres.get("ct_unsetfavorited"),
                  1400,
                );
              } else {
                webphone_api.common.ContactSetFavorite(cid, true);
                webphone_api.common.ShowToast(
                  webphone_api.stringres.get("menu_ct_setfavorite"),
                  1400,
                );
              }
            }
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_dialpad: CreateContextmenu",
        err,
      );
    }
  }

  function EditContact(ctid) {
    // open AddEditContact activity
    try {
      webphone_api.global.intentaddeditct[0] = "action=edit";
      webphone_api.global.intentaddeditct[1] = "ctid=" + ctid;

      webphone_api.$.mobile.changePage("#page_addeditcontact", {
        transition: "pop",
        role: "page",
      });
    } catch (err) {
  ...
  function MeasureDialPad() {
    ...
    try {
      ...
      webphone_api
        ...
        .css(
          ...
          webphone_api.common.HoverCalc(
            webphone_api.common.getBgColor("#page_dialpad"),
            -30,
          ),
        );
      ...
      var notwidth =
        webphone_api.common.GetDeviceWidth() -
        webphone_api.$("#dialpad_additional_header_left").width() -
        webphone_api.$("#dialpad_additional_header_right").width();
      var margin = webphone_api.common.StrToIntPx(
        webphone_api.$("#dialpad_additional_header_left").css("margin-left"),
      );

      if (webphone_api.common.isNull(margin) || margin === 0) {
        margin = 10;
      }
      ...
      webphone_api
        .$("#dialpad_notification")
        .height(
          Math.floor(
            webphone_api.$("#dialpad_additional_header_left").height(),
          ),
        );
      ...
      if (webphone_api.$("#dialpad_btn_grid").is(":visible")) {
        contentHeight =
          contentHeight - webphone_api.$("#dialpad_btn_grid").height();
      }
      ...
      if (webphone_api.$("#dialpad_title").is(":visible")) {
        webphone_api.global.bname_charcount =
          webphone_api.common.GetTextLengthThatFits(
            "app_name_dialpad",
            bname,
            webphone_api.$("#app_name_dialpad").width(),
          );
      }

      // if brandname does not fit, then hide title and make brandname div wider
      if (
        webphone_api.global.bname_charcount > 0 &&
        bname.length > webphone_api.global.bname_charcount
      ) {
        webphone_api.$("#dialpad_title").remove();
        webphone_api.$("#dialpad_additional_header_left").width("65%");
      }

      var orig_brandW = webphone_api
        .$("#dialpad_additional_header_left")
        .width();
      ...
      if (
        showfulldialpad &&
        (webphone_api.common.isNull(webphone_api.$("#dialpad_list").html()) ||
          webphone_api.$("#dialpad_list").html().length < 1)
      ) {
        // if recents are not available, then show dialpad in full screen
        var contentHeightDp =
          webphone_api.common.GetDeviceHeight() -
          webphone_api.$("#dialpad_header").height() -
          webphone_api.common.StrToIntPx(
  ...
  function HandleAutoaction() {
    // 0=nothing, 1=call (default), 2=chat, 3=video call
    try {
      if (webphone_api.global.aua_handled === true) {
        return;
      }
      webphone_api.global.aua_handled = true;
      var aua_str = webphone_api.common.GetParameter2("autoaction");
      if (
        webphone_api.common.isNull(aua_str) ||
        !webphone_api.common.IsNumber(aua_str)
      ) {
        return;
      }
      var aua = webphone_api.common.StrToInt(aua_str);
      if (webphone_api.common.isNull(aua) || aua < 1 || aua > 3) {
        return;
      }
      var ct = webphone_api.getcallto();
      if (webphone_api.common.isNull(ct) || ct.length < 1) {
        return;
      }
      ...
      if (aua === 1) {
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, HandleAutoaction initiate call to: " + ct,
        );
        StartCall(ct, false);
      } else if (aua === 2) {
        // chat
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, HandleAutoaction send message to: " + ct,
        );
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, HandleAutoaction initiate video call to: " + ct,
        );
        StartCall(ct, true);
      }
    } catch (err) {
  ...
  function MsgOnClick() {
    try {
      ...
      //BRANDEND
      var phoneNumber = webphone_api.common.Trim(
        document.getElementById("phone_number").value,
      );
  ...
  function NativePluginPopup(popupafterclose) {
    // ask user to install service plugin (service engine)
    webphone_api.common.PutToDebugLog(
      5,
      "EVENT, _dialpad: NativePluginPopup called",
    );
    ...
    try {
      ...
      var template =
        "" +
        '<div id="native_plugin_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("np_popup_title") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content adialog_alert">' +
        "<span> " +
        webphone_api.stringres.get("np_popup_msg") +
        " </span>" +
        //        '<a href="javascript:;" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" data-rel="back">' + webphone_api.stringres.get('btn_close') + '</a>' +
        //        '<a href="javascript:;" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" data-rel="back" data-transition="flow">Delete</a>' +
        "</div>" +
        '<div data-role="footer" data-theme="b" class="adialog_footer">' +
        '<a href="javascript:;" id="btn_adialog_ok" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back" data-transition="flow">' +
      ...
      webphone_api.$("#btn_adialog_ok").on("click", function () {
        webphone_api
          ...
          .on("popupafterclose", function (event) {
            ...
            webphone_api.common.PutToDebugLog(
              5,
              "EVENT, _dialpad: NativePluginPopup OK onclick",
            );

            //--            webphone_api.common.OpenWebURL(webphone_api.global.nativeplugin_path, webphone_api.stringres.get('np_download'));
            webphone_api.common.OpenWebURL(
              webphone_api.common.GetNPLocation(),
              webphone_api.stringres.get("np_download"),
            );
            setTimeout(function () {
              webphone_api.common.NPDownloadAndInstall();
            }, 150);
  ...
  var MENUITEM_DIALPAD_CALLPICKUP_101VOICE =
    "#menuitem_dialpad_callpickup_101voice";
  ...
  function CreateOptionsMenu(menuId) {
    ...
    try {
      ...
      if (webphone_api.common.isNull(menuId) || menuId.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: CreateOptionsMenu menuid null",
        );
        return;
      }
      ...
      if (webphone_api.$(menuId).length <= 0) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _dialpad: CreateOptionsMenu can't get reference to Menu",
        );
        return;
      }
      ...
      if (
        !webphone_api.common.isNull(extramenuurl) &&
        extramenuurl.length > 1 &&
        !webphone_api.common.isNull(extramenutxt) &&
        extramenutxt.length > 0
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_EXTRA +
              '"><a data-rel="back">' +
              extramenutxt +
              "</a></li>",
          )
      ...
      if (
        !webphone_api.common.isNull(extramenuurl1) &&
        extramenuurl1.length > 1 &&
        !webphone_api.common.isNull(extramenutxt1) &&
        extramenutxt1.length > 0
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_EXTRA1 +
              '"><a data-rel="back">' +
              extramenutxt1 +
              "</a></li>",
          )
      ...
      if (
        !webphone_api.common.isNull(extramenuurl2) &&
        extramenuurl2.length > 1 &&
        !webphone_api.common.isNull(extramenutxt2) &&
        extramenutxt1.length > 0
      ) {
        webphone_api
          .$(menuId)
      ...
      if (
        !webphone_api.common.isNull(extramenuurl3) &&
        extramenuurl3.length > 1 &&
        !webphone_api.common.isNull(extramenutxt3) &&
        extramenutxt3.length > 0
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_EXTRA3 +
              '"><a data-rel="back">' +
              extramenutxt3 +
              "</a></li>",
          )
      ...
      if (
        !webphone_api.common.isNull(extramenuurl4) &&
        extramenuurl4.length > 1 &&
        !webphone_api.common.isNull(extramenutxt4) &&
        extramenutxt4.length > 0
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_EXTRA4 +
              '"><a data-rel="back">' +
              extramenutxt4 +
              "</a></li>",
          )
      ...
      if (
        !webphone_api.common.isNull(extramenuurl5) &&
        extramenuurl5.length > 1 &&
        !webphone_api.common.isNull(extramenutxt5) &&
        extramenutxt5.length > 0
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_EXTRA5 +
              '"><a data-rel="back">' +
              extramenutxt5 +
              "</a></li>",
          )
      ...
      if (
        featureset > 0 &&
        !webphone_api.common.isNull(
          webphone_api.common.GetParameter("accounturi"),
        ) &&
        webphone_api.common.GetParameter("accounturi").length > 3
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_MYACCOUNT +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("myaccount") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (
        featureset > 0 &&
        !webphone_api.common.isNull(
          webphone_api.common.GetParameter("recharge"),
        ) &&
        webphone_api.common.GetParameter("recharge").length > 3
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_RECHARGE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("recharge") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.CanIUseVideo() === true) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_VIDEOCALL +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("video_call") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (
        webphone_api.common.HideSettings(
          "conference",
          webphone_api.stringres.get("sett_display_name_" + "conference"),
          "conference",
          true,
        ) === false
      ) {
          ...
          if (cfr === 1 || cfr === 3 || cfr === 5 || cfr === 6 || cfr === 7) {
            ...
            if (webphone_api.common.Glcf() === true)
              ...
              webphone_api
                ...
                .append(
                  '<li id="' +
                    MENUITEM_DIALPAD_CONFERENCEROOMS +
                    '"><a data-rel="back">' +
                    webphone_api.stringres.get("menu_confrooms") +
                    "</a></li>",
                )
                .listview("refresh");
          }
      ...
      if (webphone_api.common.CanIUseScreensharing() === true) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_SCREENSHARE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_screenshare") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (
        featureset > 0 &&
        !webphone_api.common.isNull(webphone_api.common.GetParameter("p2p")) &&
        webphone_api.common.GetParameter("p2p").length > 3
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              ...
              '"><a data-rel="back">' +
              webphone_api.stringres.get("p2p") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (featureset > 0) {
        if (
          webphone_api.common.GetParameter2("callback").length > 3 ||
          webphone_api.common.GetConfig("callbacknumber").length > 3 ||
          webphone_api.common.GetParameter2("callbacknumber").length > 3
        ) {
          webphone_api
            .$(menuId)
            .append(
              '<li id="' +
                MENUITEM_DIALPAD_CALLBACK +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("callback") +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      if (
        featureset > 0 &&
        webphone_api.common.GetParameter("accessnumber").length > 1
      ) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_DIALPAD_ACCESSNR +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_call_access") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (
        (webphone_api.common.getuseengine() ===
          webphone_api.global.ENGINE_WEBRTC &&
          (webphone_api.common.GetBrowser() === "Firefox" ||
            webphone_api.common.GetBrowser() === "Chrome")) ||
        (webphone_api.global.audio_devices_loaded === true &&
          (webphone_api.common.GetParameter("devicetype") ===
            webphone_api.common.DEVICE_WIN_SOFTPHONE() ||
            webphone_api.common.getuseengine() ===
              webphone_api.global.ENGINE_SERVICE ||
            webphone_api.common.getuseengine() ===
              webphone_api.global.ENGINE_JAVA))
      ) {
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, loading audio devices because loaded: " +
            webphone_api.global.audio_devices_loaded.toString() +
            ", getuseengine: " +
            webphone_api.common.getuseengine() +
            ", devicetype: " +
            webphone_api.common.GetParameter("devicetype") +
            ", browser: " +
            webphone_api.common.GetBrowser(),
        );
        //BRANDSTART
        if (webphone_api.common.GetConfigInt("brandid", -1) !== 50)
          // favafone
          ...
          webphone_api
            ...
            .append(
              '<li id="' +
                MENUITEM_DIALPAD_AUDIOSETTING +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("audio_title") +
                "</a></li>",
            )
            .listview("refresh");
      } else {
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, not loading audio devices because loaded: " +
            webphone_api.global.audio_devices_loaded.toString() +
            ", getuseengine: " +
            webphone_api.common.getuseengine() +
            ", devicetype: " +
      ...
      if (
        !webphone_api.common.isNull(linktext) &&
        linktext.length > 0 &&
        !webphone_api.common.isNull(linkurl) &&
        linkurl.length > 0
      ) {
        webphone_api
          .$(menuId)
      ...
      if (
        !webphone_api.common.isNull(linktext2) &&
        linktext2.length > 0 &&
        !webphone_api.common.isNull(linkurl2) &&
        linkurl2.length > 0
      ) {
        webphone_api
          .$(menuId)
      ...
      if (
        !webphone_api.common.isNull(linktext3) &&
        linktext3.length > 0 &&
        !webphone_api.common.isNull(linkurl3) &&
        linkurl3.length > 0
      ) {
        webphone_api
          .$(menuId)
      ...
      if (
        !webphone_api.common.isNull(webphone_api.global.custmenusL) &&
        webphone_api.global.custmenusL.length > 0
      ) {
        for (var i = 0; i < webphone_api.global.custmenusL.length; i++) {
          ...
          webphone_api
            .$(menuId)
            .append(
              '<li id="dialpad_custmenu_' +
                cmid +
                '"><a data-rel="back">' +
                webphone_api.global.custmenusL[i].label +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      webphone_api
        ...
        .append(
          '<li id="' +
            MENUITEM_DIALPAD_SETTINGS +
            '"><a data-rel="back">' +
            webphone_api.stringres.get("settings_title_all") +
            "</a></li>",
        )
        .listview("refresh");
  ...
  function MenuItemSelected(itemid) {
    try {
      ...
      webphone_api.$("#dialpad_menu").on("popupafterclose", function (event) {
        ...
        if (itemid.indexOf("dialpad_custmenu_") === 0) {
          // means it's a custom menu
          ...
          if (webphone_api.common.IsNumber(itemid)) {
            ...
            if (cmid >= 0) {
              ...
              webphone_api.common.PutToDebugLog(
                2,
                "EVENT, MenuItemSelected custom menu action: " +
                  action +
                  "; data: " +
                  data,
              );
              ...
              if (action.toLowerCase() === "dial") {
                ...
                webphone_api.common.PutToDebugLog(
                  1,
                  "ERROR, Invalid Menu action: " + action,
                );
              }
            }
          }
        ...
        switch (itemid) {
          case MENUITEM_DIALPAD_EXTRA:
            ...
            if (
              data.toLowerCase().indexOf("http:") === 0 ||
              data.toLowerCase().indexOf("https:") === 0
            ) {
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
              );
              webphone_api.common.StartMsg(data, "", "_dialpad");
            } else if (data.indexOf("call:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("call:") + 5),
              );
          ...
          case MENUITEM_DIALPAD_EXTRA1:
            ...
            if (
              ...
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt1"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
          ...
          case MENUITEM_DIALPAD_EXTRA2:
            ...
            if (
              ...
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt2"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
          ...
          case MENUITEM_DIALPAD_EXTRA3:
            ...
            if (
              ...
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt3"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
          ...
          case MENUITEM_DIALPAD_EXTRA4:
            ...
            if (
              ...
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt4"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
          ...
          case MENUITEM_DIALPAD_EXTRA5:
            ...
            if (
              ...
              webphone_api.common.OpenWebURL(
                data,
                webphone_api.common.GetParameter("extramenutxt5"),
              );
            } else if (data.indexOf("chat:") === 0) {
              data = webphone_api.common.Trim(
                data.substring(data.indexOf("chat:") + 5),
          ...
          case MENUITEM_DIALPAD_PROVIDER:
            webphone_api.common.OpenWebURL(
              webphone_api.common.GetParameter("homepage"),
              webphone_api.stringres.get("myprovider"),
            );
            break;
          ...
          case MENUITEM_DIALPAD_CUSTOM_LINK:
            webphone_api.common.OpenWebURL(
              webphone_api.common.GetParameter("linkurl"),
              webphone_api.common.GetParameter("linktext"),
            );
            break;
          case MENUITEM_DIALPAD_CUSTOM_LINK2:
            webphone_api.common.OpenWebURL(
              webphone_api.common.GetParameter("linkurl2"),
              webphone_api.common.GetParameter("linktext2"),
            );
            break;
          case MENUITEM_DIALPAD_CUSTOM_LINK3:
            webphone_api.common.OpenWebURL(
              webphone_api.common.GetParameter("linkurl3"),
              webphone_api.common.GetParameter("linktext3"),
            );
            break;
        }
      });
  ...
  function ConferenceDialpad(number) {
    try {
      ...
      if (cfr === 1 || cfr === 3) {
        ...
        var template =
          "" +
          '<div id="conferencedtmf_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
          popupWidth +
          'px;">' +
          '<div data-role="header" data-theme="b">' +
          '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
          ...
          '<input type="text" id="conferencedtmf_input" name="setting_item" data-theme="a" autocapitalize="off" value="' +
          number +
          '"/>' +
          '<button id="btn_pickct" class="btn_nexttoinput ui-btn ui-btn-corner-all ui-btn-b noshadow"><img src="' +
          webphone_api.common.GetElementSource() +
          "images/" +
          btnimage +
          '"></button>' +
        ...
        webphone_api.$("#adialog_positive").on("click", function (event) {
          webphone_api.common.PutToDebugLog(
            5,
            "EVENT, call Conferencedtmf ok onclick",
          );

          var textboxval = webphone_api.common.Trim(textBox.value);
          webphone_api
            .$("#conferencedtmf_popup")
            .on("popupafterclose", function (event) {
              if (
                ...
                webphone_api.common.PutToDebugLog(
                  2,
                  "EVENT, mlogic ConferenceDialpad: " + textboxval,
                );
                webphone_api.conference(textboxval);
              } else {
                webphone_api.common.ShowToast(
                  webphone_api.stringres.get("err_msg_4"),
                );
              }
            });
        });
  ...
  function Integration(popupafterclose) {
    try {
      ...
      var list = "";
      var item =
        '<li id="[ITEMID]"><a data-rel="back" title="[ITEMHINT]">[ITEMTITLE]</a></li>';
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("menu_int_outlook"),
      );
      itemTemp = itemTemp.replace(
        "[ITEMHINT]",
        webphone_api.stringres.get("hint_int_outlook"),
      );
      list = list + itemTemp;
      itemTemp = "";
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("menu_int_chrome"),
      );
      itemTemp = itemTemp.replace(
        "[ITEMHINT]",
        webphone_api.stringres.get("hint_int_chrome"),
      );
      list = list + itemTemp;
      itemTemp = "";
      ...
      var template =
        "" +
        '<div id="integration_window" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        "px; min-width: " +
        Math.floor(popupWidth * 0.6) +
        'px;">' +
        ...
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("menu_integration") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content" style="padding: 0; margin: 0;">' +
              ...
              if (itemid === "#item_integrate_outlook") {
                ...
                webphone_api.common.WinSoftphoneHttpReq(
                  ...
                  function (resp) {
                    webphone_api.common.PutToDebugLog(
                      2,
                      "EVENT, Integration outlook answer: " + resp,
                    );
                  },
                );
                ...
                webphone_api.common.PutToDebugLog(
                  4,
                  "EVENT, _dialpad: Integration chrome clicked",
                );

                var url =
                  webphone_api.common.AddJscommport(
                    webphone_api.global.WIN_SOFTPHONE_URL,
                  ) + "?extcmd_integrate_chorme";
                webphone_api.common.WinSoftphoneHttpReq(
                  url,
                  "GET",
                  "",
                  ...
                  function (resp) {
                    webphone_api.common.PutToDebugLog(
                      2,
                      "EVENT, Integration chrome answer: " + resp,
                    );
                  },
                );
              } else {
                webphone_api.common.PutToDebugLog(
                  2,
                  "ERROR, _dialpad: Integration invalid item id: " + itemid,
                );
              }
            });
        });
  ...
  function Folders(popupafterclose) {
    try {
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("menu_folders_bin"),
      );
      itemTemp = itemTemp.replace(
        "[ITEMHINT]",
        webphone_api.stringres.get("hint_folders_bin"),
      );
      list = list + itemTemp;
      itemTemp = "";
      ...
      itemTemp = itemTemp.replace(
        "[ITEMTITLE]",
        webphone_api.stringres.get("menu_folders_data"),
      );
      itemTemp = itemTemp.replace(
        "[ITEMHINT]",
        webphone_api.stringres.get("hint_folders_data"),
      );
      list = list + itemTemp;
      itemTemp = "";
      ...
      var template =
        "" +
        '<div id="folders_window" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        "px; min-width: " +
        Math.floor(popupWidth * 0.6) +
        'px;">' +
        ...
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("menu_folders") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content" style="padding: 0; margin: 0;">' +
        ...
        webphone_api
          ...
          .on("popupafterclose", function (event) {
            ...
            if (itemid === "#item_folders_bin") {
              webphone_api.common.PutToDebugLog(
                4,
                "EVENT, _dialpad: folders BIN clicked",
              );
              ...
              webphone_api.common.PutToDebugLog(
                4,
                "EVENT, _dialpad: folders DATA clicked",
              );
              ...
              webphone_api.common.WinSoftphoneHttpReq(
                ...
                function (resp) {
                  webphone_api.common.PutToDebugLog(
                    2,
                    "EVENT, folders DATA answer: " + resp,
                  );
                },
              );
            } else {
              webphone_api.common.PutToDebugLog(
                2,
                "ERROR, _dialpad: folders invalid item id: " + itemid,
              );
            }
          });
      });
    } catch (err) {
      webphone_api.common.PutToDebugLogException(2, "_dialpad: Folders", err);
    }
  }
  ...
  function MyAccount() {
    try {
      ...
      if (
        webphone_api.common.IsMizuServer() === true ||
        uri.indexOf("/mvweb") > 0
      ) {
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: MyAccount", err);
    }
  }

  function ScreenShare(phoneNr) {
    // initiate screenshare call if a number is entered in phone field, or request a number from the user
    try {
      var field = document.getElementById("phone_number");
      if (webphone_api.common.isNull(field)) {
        return;
      ...
      if (!webphone_api.common.isNull(number)) {
        ...
        if (number.length > 0) {
          ...
          webphone_api.common.PutToDebugLog(
            4,
            "EVENT, _dialpad initiate screenshare call to: " + number,
          );
      ...
      var template =
        "" +
        '<div id="adialog_screensharecall" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("screenshare_call") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content adialog_btn_nexttoinput">' +
        "<span>" +
        webphone_api.stringres.get("phone_nr") +
        ":</span>" +
        '<div style="clear: both;"><!--//--></div>' +
        ...
        '<div data-role="footer" data-theme="b" class="adialog_footer">' +
        '<a href="javascript:;" id="adialog_positive" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back" data-transition="flow">' +
        webphone_api.stringres.get("btn_sharescreen") +
        "</a>" +
        '<a href="javascript:;" id="adialog_negative" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b adialog_2button" data-rel="back">' +
        webphone_api.stringres.get("btn_cancel") +
        "</a>" +
      ...
      if (!webphone_api.common.isNull(screensharecall)) {
        if (!webphone_api.common.isNull(phoneNr) && phoneNr.length > 0) {
          screensharecall.value = phoneNr;
        }
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api
          .$("#adialog_screensharecall")
          .on("popupafterclose", function (event) {
            number = screensharecall.value;

            webphone_api.common.PutToDebugLog(
              5,
              "EVENT, _dialpad ScreenShare 1 ok: " + number,
            );

            if (
              webphone_api.common.isNull(number) ||
              webphone_api.common.Trim(number).length < 1
            ) {
              return;
            } else {
              number = webphone_api.common.Trim(number);
  ...
  function CreditRecharge() {
    try {
      ...
      if (webphone_api.common.Trim(ruri).indexOf("*") !== 0) {
        // if starts with * => httpapi ELSE link
        webphone_api.common.OpenWebURL(
          ruri,
          webphone_api.stringres.get("recharge"),
        );
      ...
      var template =
        "" +
        '<div id="adialog_recharge" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        ...
        '<div role="main" class="ui-content adialog_content">' +
        "<span>" +
        webphone_api.stringres.get("recharge_msg") +
        ":</span>" +
      ...
      if (!webphone_api.common.isNull(recharge)) {
        recharge.focus();
      } // setting cursor to text input
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, _dialpad CreditRecharge 1 ok",
        );

        var pin = recharge.value;

        if (
          webphone_api.common.isNull(pin) ||
          webphone_api.common.Trim(pin).length < 1
        ) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("recharge_error"),
          );
          return;
        } else {
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_dialpad: CreditRecharge",
        err,
      );
    }
  }

  function VideoCall(phoneNr) {
    // initiate video call if a number is entered in phone field, or request a number from the user
    try {
      var field = document.getElementById("phone_number");
      if (webphone_api.common.isNull(field)) {
        return;
      ...
      var lastDialed = webphone_api.common.GetParameter("redial");
      if (webphone_api.common.isNull(lastDialed)) {
        lastDialed = "";
      }
      ...
      var template =
        "" +
        '<div id="adialog_videocall" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        ...
        ":</span>" +
        '<div style="clear: both;"><!--//--></div>' +
        '<input type="text" id="videocall_input" name="videocall_input" value="' +
        lastDialed +
        '" data-theme="a" autocapitalize="off"/>' +
        '<button id="btn_pickct" class="btn_nexttoinput ui-btn ui-btn-corner-all ui-btn-b noshadow"><img src="' +
        webphone_api.common.GetElementSource() +
        "images/" +
        btnimage +
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api
          ...
          .on("popupafterclose", function (event) {
            ...
            webphone_api.common.PutToDebugLog(
              5,
              "EVENT, _dialpad VideoCall 1 ok: " + number,
            );
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: VideoCall", err);
    }
  }
  ...
  function MenuVoicemail() {
    try {
      ...
      if (
        (webphone_api.common.isNull(vmNumber) || vmNumber.length < 1) &&
        webphone_api.common.IsMizuServer() === true
      ) {
        vmNumber = "5001";
  ...
  function Callback() {
    ...
    try {
      ...
      if (cburi.length < 3) {
        cburi = webphone_api.common.GetConfig("callback");
      }

      var cbnr = webphone_api.common.GetParameter2("callbacknumber");
      if (cbnr.length < 3) {
        cbnr = webphone_api.common.GetConfig("callbacknumber");
      }
      ...
      if (!webphone_api.common.isNull(cburi) && cburi.length > 2) {
        ...
        var template =
          "" +
          '<div id="adialog_callback" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
          popupWidth +
          'px;">' +
          '<div data-role="header" data-theme="b">' +
          '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
          ...
          '<div role="main" class="ui-content adialog_content">' +
          "<span>" +
          webphone_api.stringres.get("callback_src") +
          "</span>" +
        ...
        if (!webphone_api.common.isNull(callback)) {
          callback.focus();
        } // setting cursor to text input

        var lastCallbackNr =
          webphone_api.common.GetParameter("last_callback_nr");

        if (
          !webphone_api.common.isNull(lastCallbackNr) &&
          lastCallbackNr.length > 0
        ) {
        ...
        webphone_api.$("#adialog_positive").on("click", function (event) {
          webphone_api.common.PutToDebugLog(
            5,
            "EVENT, _dialpad Phone2Phone 1 ok",
          );

          var callbacknr = callback.value;

          if (
            webphone_api.common.isNull(callbacknr) ||
            webphone_api.common.Trim(callbacknr).length < 1
          ) {
            webphone_api.common.ShowToast(
              webphone_api.stringres.get("callback_src"),
            );
        ...
        if (webphone_api.isregistered() === true) {
          ...
          if (os === "Windows" || os === "MacOS" || os === "Linux") {
            htmlcont =
              webphone_api.stringres.get("cb_callonnative") +
              ": " +
              sip +
              "<br /><br />" +
              webphone_api.stringres.get("cb_callonmobile") +
              ": " +
              mob;
          } else {
            htmlcont =
              webphone_api.stringres.get("cb_callonmobile") + ": " + mob;
          }
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR,_dialpad: Callback, cannot find callback method, number: " +
            cbnr +
            "; uri: " +
            cburi,
        );
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: Callback", err);
    }
  }
  ...
  function onStop(event) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_dialpad: onStop", err);
    }
  }
