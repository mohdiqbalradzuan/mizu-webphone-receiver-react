...
webphone_api._contactdetails = (function () {
  ...
  function onCreate(event) {
    ...
    try {
      ...
      {
        if (
          webphone_api.$.mobile.activePage.attr("id") === "page_contactdetails"
        ) {
      ...
      webphone_api
        .$("#contactdetails_menu_ul")
        .on("click", "li", function (event) {
          MenuItemSelected(webphone_api.$(this).attr("id"));
        });
      webphone_api.$("#btn_contactdetails_menu").on("click", function () {
        CreateOptionsMenu("#contactdetails_menu_ul");
      });
      webphone_api
        .$("#btn_contactdetails_menu")
    ...
    try {
      ...
      webphone_api
        ...
        .css(
          ...
          webphone_api.common.HoverCalc(
            webphone_api.common.getBgColor("#page_contactdetails"),
            -30,
          ),
        );
      ...
      if (
        !webphone_api.common.isNull(
          document.getElementById("contactdetails_title"),
        )
      ) {
        document.getElementById("contactdetails_title").innerHTML =
          webphone_api.stringres.get("ctdetails_title");
      }
      webphone_api
      ...
      if (
        !webphone_api.common.isNull(
          document.getElementById("ctdetails_btnback"),
        )
      ) {
        document.getElementById("ctdetails_btnback").innerHTML =
          "<b>&LT;</b>&nbsp;" +
          webphone_api.stringres.get("ctdetails_btnback_txt");
      }
      ...
      var ctname = webphone_api.common.GetIntentParam(
        webphone_api.global.intentctdetails,
        "ctname",
      );
      var ctnumber = webphone_api.common.GetIntentParam(
        webphone_api.global.intentctdetails,
        "ctnumber",
      );
      ...
      try {
        ...
        webphone_api.common.PutToDebugLogException(
          2,
          "_contactdetails: onStart can't convert ctid to INT",
          err,
        );
      }
      ...
      if (
        ctid < 0 &&
        !webphone_api.common.isNull(ctnumber) &&
        ctnumber.length > 0
      ) {
      ...
      if (ctid >= 0) {
        ...
        if (isfavorite === true) {
          webphone_api
            .$("#btn_contactdetails_favorite")
            .attr(
              "src",
              "" +
                webphone_api.common.GetElementSource() +
                "images/btn_star_on_normal_holo_light.png",
            )
            .attr("title", webphone_api.stringres.get("menu_ct_unsetfavorite"));
        } else {
          webphone_api
            .$("#btn_contactdetails_favorite")
            .attr(
              ...
              "" +
                webphone_api.common.GetElementSource() +
                "images/btn_star_off_normal_holo_light.png",
            )
            .attr("title", webphone_api.stringres.get("menu_ct_setfavorite"));
        }
      } else {
        iscontact = false;
        if (webphone_api.common.isNull(ctname)) {
          ctname = "";
        }
        if (webphone_api.common.isNull(ctnumber)) {
          ctnumber = "";
        }
      ...
      frompage = webphone_api.common.GetIntentParam(
        webphone_api.global.intentctdetails,
        "frompage",
      );
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: onStart",
        err,
      );
    }
  }

  function MeasureContactdetails() {
    ...
    try {
      if (webphone_api.common.isNull(contact) || contact.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _contactdetails PopulateData contact is NULL",
        );
        return;
      }
      ...
      var content =
        '<div id="contact_name">' +
        "<p>" +
        contact[webphone_api.common.CT_NAME] +
        "</p>" +
        '<div id="contact_blocked">' +
        '<img src="' +
        webphone_api.common.GetElementSource() +
        'images/icon_block.png" id="contact_blocked_img" />' +
        "</div>" +
        '<div id="contact_favorite">' +
        '<img id="btn_contactdetails_favorite" style="display: none;" src="' +
        webphone_api.common.GetElementSource() +
        'images/btn_star_off_normal_holo_light.png" title="" />' +
        "</div>" +
        "</div>";
      ...
      if (!webphone_api.common.isNull(numbers) && numbers.length > 0) {
        if (webphone_api.common.IsContactBlocked(null, numbers)) {
          isctblocked = true;
        }
      }
      ...
      if (
        webphone_api.common.GetColortheme() === 22 ||
        webphone_api.common.GetColortheme() === 23
      ) {
        ...
        for (var i = 0; i < numbers.length; i++) {
          ...
          if (enablepres) {
            ...
            if (!webphone_api.common.isNull(presobj)) {
              ...
              if (
                !webphone_api.common.isNull(laststr) &&
                webphone_api.common.IsNumber(laststr)
              )
            ...
            if (
              ...
              presence.length < 1 ||
              presence ===
                "-1" /* || (lastcheck > 0 && NOW - lastcheck > 20000)*/
            ) {
              presenceimg = "";
      ...
      if (!webphone_api.common.isNull(numbers) && numbers.length > 0) {
        for (var i = 0; i < numbers.length; i++) {
          (function (i) {
            webphone_api.$("#cd_call_" + i).on("click", function () {
              OnItemClick(i, 0);
            });
            webphone_api.$("#cd_msg_" + i).on("click", function () {
              OnItemClick(i, 1);
            });
            webphone_api.$("#cd_video_" + i).on("click", function () {
              OnItemClick(i, 2);
            });
          })(i);
        }
      }
      webphone_api.$("#ct_screensh_entry_button").on("click", function () {
        ScreenSh();
      });
      webphone_api.$("#ct_filetransf_entry_button").on("click", function () {
        FileTrasnf();
      });
      webphone_api.$("#ct_edit_entry_button").on("click", function () {
        EditContact();
      });
      webphone_api.$("#ct_delete_entry_button").on("click", function () {
        DeleteContactPopup();
      });
      webphone_api.$("#ct_save_entry_button").on("click", function () {
        SaveContact();
      });
      webphone_api.$("#ct_allcontacts_entry_button").on("click", function () {
      ...
      if (ctid >= 0) {
        // means it's a contact, not JUST A NUMBER
        webphone_api.$("#btn_contactdetails_favorite").show();
        isfavorite = webphone_api.common.ContactIsFavorite(ctid);
        if (isfavorite === true) {
          webphone_api
  ...
  function FileTrasnf() {
    ...
    try {
      webphone_api.common.PutToDebugLog(
        2,
        "EVENT, _contactdetails: FileTrasnf",
      );
      var numbers = contact[webphone_api.common.CT_NUMBER];
  ...
  function ToggleFavorite() {
    try {
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: ToggleFavorite",
        err,
      );
    }
  }
  ...
  function OnItemClick(contactid, type) {
    // type: 0=call, 1=chat, 2=video call
    try {
      if (trigerred) {
        return;
      }
      ...
      if (webphone_api.common.isNull(contactid)) {
        return;
      }
      ...
      if (type === 0) {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _contactdetails initiate call to: " + to,
        );

        setTimeout(
          function () //-- timeout, so webphone_api.$.mobile.back(); won't close call page
          {
        ...
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _contactdetails initiate video call to: " + to,
        );
  ...
  function CreateOptionsMenu(menuId) {
    ...
    try {
      ...
      if (webphone_api.common.isNull(menuId) || menuId.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _contactdetails: CreateOptionsMenu menuid null",
        );
        return;
      }
      ...
      if (webphone_api.$(menuId).length <= 0) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _contactdetails: CreateOptionsMenu can't get reference to Menu",
        );
        return;
      }
      ...
      if (iscontact) {
        ...
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CONTACTDETAILS_DELETE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_deletecontact") +
              "</a></li>",
          )
        ...
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CONTACTDETAILS_CREATE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_createcontact") +
              "</a></li>",
          )
      ...
      if (isctblocked === true) {
        blocktitle = webphone_api.stringres.get("menu_unblock_contact");
      }
      ...
      webphone_api
        ...
        .append(
          '<li id="' +
            MENUITEM_CONTACTDETAILS_BLOCKCT +
            '"><a data-rel="back">' +
            blocktitle +
            "</a></li>",
        )
      ...
      webphone_api
        ...
        .append(
          '<li id="' +
            MENUITEM_CONTACTDETAILS_FAVORITE +
            '"><a data-rel="back">' +
            favtitle +
            "</a></li>",
        )
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: CreateOptionsMenu",
        err,
      );
    }
  ...
  function MenuItemSelected(itemid) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: MenuItemSelected",
        err,
      );
    }
  }
  ...
  function ToggleCtBlocked() {
    try {
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: ToggleCtBlocked",
        err,
      );
    }
  }
  ...
  function SaveContact() {
    try {
      ...
      webphone_api.global.intentaddeditct[1] =
        "numbertoadd=" + contact[webphone_api.common.CT_NUMBER][0];
      var name = contact[webphone_api.common.CT_NAME];
      if (
        webphone_api.common.isNull(name) ||
        name.length < 1 ||
        name === contact[webphone_api.common.CT_NUMBER][0]
      ) {
        name = "";
      }
  ...
  function DeleteContactPopup(popupafterclose) {
    try {
      ...
      var template =
        "" +
        '<div id="delete_contact_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_contactdetails: DeleteContactPopup",
        err,
      );
    }
  }
      ...
      webphone_api
        ...
        .on("popupafterclose", function (event) {
          ...
          webphone_api.common.SaveContactsFile(function (issaved) {
            webphone_api.common.PutToDebugLog(
              4,
              "EVENT, _contactdetails: DeleteContact SaveContactsFile: " +
                issaved.toString(),
            );
          });
