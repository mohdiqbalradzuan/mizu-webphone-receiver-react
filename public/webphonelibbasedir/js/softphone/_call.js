...
webphone_api._call = (function () {
  ...
  function onCreate(event) {
    ...
    try {
      ...
      webphone_api.$("#btn_accept").on("click", function () {
        if (webphone_api.common.CanLog(4)) {
          webphone_api.common.PutToDebugLog(
            4,
            "EVENT, _call AcceptCall onclick",
          );
        }
        AcceptCall(true);
      });
      ...
      webphone_api.$("#btn_ml_accept").on("click", function () {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _call multiline Accept onclick",
        );
        AcceptCall(true);
      });
      ...
      webphone_api.$("#btn_ml_reject").on("click", function () {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _call RejectCallMultiline onclick",
        );
      ...
      webphone_api.$("#btn_ml_more").on("click", function () {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _call multiline more onclick",
        );
      ...
      webphone_api
        .$("#btn_hangup")
        .attr("title", webphone_api.stringres.get("hint_hangup"));
      webphone_api
        .$("#btn_accept")
        .attr("title", webphone_api.stringres.get("hint_accept"));
      webphone_api
        .$("#btn_reject")
        .attr("title", webphone_api.stringres.get("hint_reject"));
      webphone_api
        .$("#calledcaller")
        .attr("title", webphone_api.stringres.get("hint_called"));
      webphone_api
        .$("#status_call")
        .attr("title", webphone_api.stringres.get("hint_callstatus"));
      webphone_api
        .$("#call_duration")
        .attr("title", webphone_api.stringres.get("hint_callduration"));
      ...
      webphone_api
        .$("#btn_reject_ml")
        .attr("title", webphone_api.stringres.get("hint_reject_new"));
      webphone_api
        .$("#btn_ml_more")
        .attr("title", webphone_api.stringres.get("hint_more"));

      webphone_api.$("#btn_audiodevice").on("click", function () {
        webphone_api.common.PutToDebugLog(
          4,
          "EVENT, _call webphone_audiodevice onclick",
        );
      ...
      webphone_api.$(window).resize(function () // window resize handling
      {
        if (webphone_api.$.mobile.activePage.attr("id") === "page_call") {
          if (!webphone_api.common.isNull(timerid)) {
      ...
      webphone_api.$("#numpad_btn_dp_2").on("click", function () {
        SendDtmf("2");
      });
      webphone_api.$("#numpad_btn_dp_3").on("click", function () {
        SendDtmf("3");
      });
      webphone_api.$("#numpad_btn_dp_4").on("click", function () {
        SendDtmf("4");
      });
      webphone_api.$("#numpad_btn_dp_5").on("click", function () {
        SendDtmf("5");
      });
      webphone_api.$("#numpad_btn_dp_6").on("click", function () {
        SendDtmf("6");
      });
      webphone_api.$("#numpad_btn_dp_7").on("click", function () {
        SendDtmf("7");
      });
      webphone_api.$("#numpad_btn_dp_8").on("click", function () {
        SendDtmf("8");
      });
      webphone_api.$("#numpad_btn_dp_9").on("click", function () {
        SendDtmf("9");
      });
      webphone_api.$("#numpad_btn_dp_0").on("click", function () {
        SendDtmf("0");
      });
      webphone_api.$("#numpad_btn_dp_ast").on("click", function () {
        SendDtmf("*");
      });
      webphone_api.$("#numpad_btn_dp_diez").on("click", function () {
        SendDtmf("#");
      });
      ...
      webphone_api.$("#page_call").keydown(function (event) {
        try {
          ...
          if (charCode === 13) {
            ...
            } else if (webphone_api.$("#acceptreject_layout").is(":visible")) {
              // acceptreject_layout   check is visible
              webphone_api.$("#btn_accept").click();
              event.preventDefault();
            } else if (webphone_api.$("#mline_layout").is(":visible")) {
              // acceptreject_layout   check is visible
              webphone_api.$("#btn_ml_accept").click();
              event.preventDefault();
            }
          } else if (charCode === 27 || charCode === 8) {
            // ESC or Backspace
            var active_popups =
              webphone_api.$.mobile.activePage.find(".messagePopup");
            if (
              ...
              event.preventDefault();
            } else if (webphone_api.$("#hangup_layout").is(":visible")) {
              // acceptreject_layout   check is visible
          ...
          webphone_api.common.PutToDebugLogException(2, "_call: keydown", err);
        }
      });
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: onCreate", err);
    }
  }
  ...
  function onStart(event) {
    try {
      ...
      if (
        !webphone_api.common.isNull(document.getElementById("app_name_call")) &&
        webphone_api.common.GetParameter("devicetype") !==
          webphone_api.common.DEVICE_WIN_SOFTPHONE()
      ) {
        document.getElementById("app_name_call").innerHTML =
      ...
      webphone_api
        ...
        .css(
          ...
          webphone_api.common.HoverCalc(
            webphone_api.common.getBgColor("#call_header"),
            -30,
          ),
        );
      ...
      webphone_api
        ...
        .attr(
          ...
          "" +
            ...
            "images/btn_hangup_txt.png",
        );

      if (
        !webphone_api.common.isNull(document.getElementById("btn_audiodevice"))
      ) {
        document.getElementById("btn_audiodevice").innerHTML =
          webphone_api.stringres.get("btn_audio_device");
      }

      if (
        webphone_api.common.GetParameterBool("displayvolumecontrols", false) ===
        true
      ) {
      ...
      if (
        webphone_api.common.GetParameterBool("displayaudiodevice", false) ===
        true
      ) {
      ...
      var invalue = webphone_api.common.GetParameter("volumein");
      if (
        webphone_api.common.isNull(invalue) ||
        invalue.length < 1 ||
        !webphone_api.common.IsNumber(invalue)
      ) {
        invalue = "50";
      }
      ...
      if (
        webphone_api.common.isNull(outvalue) ||
        outvalue.length < 1 ||
        !webphone_api.common.IsNumber(outvalue)
      ) {
        outvalue = "50";
      }
      ...
      webphone_api.$("#volumein").on("slidestop", function (event, ui) {
        ...
        if (webphone_api.common.isNull(setval) || setval.length < 1) {
          return;
        }
        ...
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, volumein slidestop: " + this.value,
        );
      ...
      webphone_api.$("#volumeout").on("slidestop", function (event, ui) {
        ...
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, volumeout slidestop: " + this.value,
        );

        webphone_api.setvolume(1, setval);
      });

      calltype = webphone_api.common.GetIntentParam(
        webphone_api.global.intentcall,
        "calltype",
      );
      var callmodestr = webphone_api.common.GetIntentParam(
        webphone_api.global.intentcall,
        "callmode",
      );
      if (
        !webphone_api.common.isNull(callmodestr) &&
        webphone_api.common.IsNumber(callmodestr)
      ) {
        callmode = webphone_api.common.StrToInt(callmodestr);
      }

      webphone_api.global.callName = ""; // reset webphone_api.global.callName

      callnumber = webphone_api.common.GetIntentParam(
        webphone_api.global.intentcall,
        "number",
      );
      webphone_api.global.callName = webphone_api.common.GetIntentParam(
        webphone_api.global.intentcall,
        "name",
      );

      if (
        webphone_api.common.isNull(webphone_api.global.callName) ||
        webphone_api.global.callName.length < 1
      ) {
        webphone_api.global.callName =
          webphone_api.common.GetContactNameFromNumber(callnumber);
      }

      var telsearchurl = webphone_api.common.GetParameter2("telsearchurl");
      if (webphone_api.common.isNull(telsearchurl) || telsearchurl.length < 3) {
        telsearchurl = webphone_api.parameters["telsearchurl"];
      }
      if (
        !webphone_api.common.isNull(telsearchurl) &&
        telsearchurl.length > 3 &&
        (webphone_api.global.callName.length < 1 ||
          webphone_api.global.callName === callnumber)
      ) {
        webphone_api.gettelsearchname(callnumber, function (recname) {
          if (
            webphone_api.common.isNull(recname) ||
            recname.length < 2 ||
            recname.length > 60
          ) {
            return;
      ...
      if (calltype === "incoming") {
        webphone_api.GetIncomingDisplay(function (disp) {
          if (
            !webphone_api.common.isNull(disp) &&
            disp.length > 0 &&
            peerdetails.indexOf(disp) < 0
          ) {
            disp = disp.replace("\n", "");
      ...
      if (calltype === "outgoing") {
        ...
        setTimeout(function () {
          ...
          if (
            ...
            //OPSEND
            !webphone_api.common.isNull(ratinguri) &&
            ratinguri.length > 2 &&
            !webphone_api.common.isNull(callnumber) &&
            callnumber.length > 0 &&
            (webphone_api.common.isNull(webphone_api.global.rating) ||
              webphone_api.global.rating.length < 1) // means rating is not received from signaling
          ) {
            webphone_api.needratingrequest(
              function (
                val, // API_NeedRatingRequest
              ) {
                if (val === true) {
      ...
      if (calltype === "incoming") {
        if (
          webphone_api.common.GetParameterBool("autoaccept", false) === true ||
          webphone_api.common.GetParameterInt("enableautoaccept", 1) === 3
        ) {
          webphone_api.$("#hangup_layout").show();
          webphone_api.$("#callfunctions_layout").show();
          webphone_api.$("#acceptreject_layout").hide();
      ...
      if (callmode > 0 && webphone_api.common.CanIUseVideo() === true) {
        ...
        if (
          webphone_api.common.GetParameterInt("softphonevideomode", 0) === 1
        ) {
          // hide Full Screeen button in windows softphone, because it's not working
          webphone_api.$("#div_video_fullscreen_button").hide();
        }
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, call onstart video container displayed",
        );
      }
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: onStart", err);
    }
  }
  ...
  function NormalizeDisplayDetails(det_in) {
    try {
      ...
      while (idx < darr.length) {
        if (
          webphone_api.common.isNull(darr[idx]) ||
          webphone_api.common.Trim(darr[idx]).lengh < 1
        ) {
          darr.splice(idx, 1);
        } else {
          idx++;
      ...
      for (var i = 0; i < darr.length; i++) {
        if (
          webphone_api.common.isNull(darr[i]) ||
          webphone_api.common.Trim(darr[i]).lengh < 1
        ) {
          continue;
        }
  ...
  function OnNewIncomingCall() {
    try {
      webphone_api.common.PutToDebugLog(
        5,
        "EVENT, _call handle OnNewIncomingCall on line: " +
          webphone_api.global.aline.toString(),
      );
      var ep = webphone_api.common.GetEndpoint(
        1025,
        webphone_api.global.aline,
        "",
        "",
        "",
        false,
      ...
      if (webphone_api.common.isNull(ep) || ep.length < 5) {
        webphone_api.common.PutToDebugLog(
          3,
          "WARNING, _call OnNewIncomingCall: ep is NULL for line A: " +
            webphone_api.global.aline.toString(),
        );

        //handle bug / workaround
        var curraline = webphone_api.common.GetFreeLine();
        webphone_api.common.SetALineInternal(curraline, 51);
        ep = webphone_api.common.GetEndpoint(
          1026,
          webphone_api.global.aline,
          "",
          "",
        ...
        if (webphone_api.common.isNull(ep) || ep.length < 5) {
          webphone_api.common.PutToDebugLog(
            2,
            "ERROR, _call OnNewIncomingCall: ep is NULL for line B: " +
              webphone_api.global.aline.toString(),
          );
...
*/
        ...
        for (var i = 0; i < webphone_api.global.ep.length; i++) {
          if (
            webphone_api.common.isNull(webphone_api.global.ep[i]) ||
            webphone_api.global.ep[i].length < 5
          ) {
            continue;
          }
        ...
        for (var i = webphone_api.global.ep.length - 1; i >= 0; i--) {
          ...
          if (
            webphone_api.global.ep[i][webphone_api.common.EP_FLAGDEL] == "false"
          ) {
            // found one active line, set it
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, SetLine called from RejectCallMultiline",
            );
            webphone_api.setline(
              webphone_api.common.StrToInt(
                webphone_api.global.ep[i][webphone_api.common.EP_LINE],
              ),
            );
            break;
          }
      ...
      if (callapi) {
        ...
        if (!webphone_api.common.isNull(webphone_api.global.ep)) {
          for (var i = 0; i < webphone_api.global.ep.length; i++) {
            ...
            if (webphone_api.common.isNull(eptmp) || eptmp.length < 1) {
              continue;
            }

            if (eptmp[webphone_api.common.EP_FLAGDEL] === "true") {
              continue;
            }

            if (
              !webphone_api.common.isNull(eptmp[webphone_api.common.EP_LINE]) &&
              webphone_api.common.IsNumber(
                eptmp[webphone_api.common.EP_LINE],
              ) === true
            ) {
              if (
                setuptimeTmp <
                webphone_api.common.StrToInt(
                  eptmp[webphone_api.common.EP_SETUPTIME],
                )
              ) {
                prevline = webphone_api.common.StrToInt(
                  eptmp[webphone_api.common.EP_LINE],
                );
              }
            }
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, mlogic API_Accept AcceptHold",
        );
        ...
        if (prevline > 0) {
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT, API_Hold mainlogic hold call from cl AcceptHold; " +
              " on line: " +
              prevline,
          );
          ...
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT, AcceptHold hold finished",
          );
        }
      }
    } catch (err) {
      webphone_api.common.PutToDebugLogException(2, "_call: AcceptHold", err);
    }
  }
  ...
  function AcceptEnd(callapi) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: AcceptEnd", err);
    }
  }
  ...
  function MeasureCall() {
    ...
    try {
      ...
      webphone_api
        ...
        .height(
          webphone_api.common.GetDeviceHeight() -
            webphone_api.$("#call_header").height() -
            webphone_api.$(".separator_line_thick").height(),
        );
      ...
      var numpadHeight =
        pageHeight -
        webphone_api.$("#hangup_layout").height() -
        webphone_api.$("#callfunctions_layout").height() -
        webphone_api.$(".separator_color_bg").height() -
        12;
      if (webphone_api.$("#mlcontainer").is(":visible")) {
        numpadHeight =
          numpadHeight - webphone_api.$("#mlcontainer").height() - 2;
      }
      ...
      webphone_api
        .$("#numpad_number_container")
        .css("line-height", rowHeight + "px");
      ...
      if (calltype === "outgoing") {
        ...
        if (volumevisible) {
          pageHeight = pageHeight - webphone_api.$("#volumecontrols").height();
        }
        if (audiodevicevisible) {
          pageHeight =
            pageHeight - webphone_api.$("#audiodevice_container").height();
        }
        pageHeight =
          pageHeight -
          webphone_api.$("#mlcontainer").height() -
          webphone_api.$(".separator_line_thick").height();
        ...
        var mTop =
          (pageHeight -
            webphone_api.$("#contact_image_img").height() -
            webphone_api.$("#page_call_additional_info").height()) /
          2;
      ...
      if (calltype === "incoming") {
        if (
          document.getElementById("acceptreject_layout").style.display ===
          "block"
        ) {
          pageHeight =
            pageHeight - webphone_api.$("#acceptreject_layout").height() - 3;
          if (volumevisible) {
            pageHeight =
              pageHeight - webphone_api.$("#volumecontrols").height();
          }
          if (audiodevicevisible) {
            pageHeight =
              pageHeight - webphone_api.$("#audiodevice_container").height();
      ...
      if (webphone_api.$("#video_container").is(":visible")) {
        ...
        if (
          !webphone_api.common.isNull(vh) &&
          webphone_api.common.IsNumber(vh)
        ) {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: MeasureCall", err);
    }
  }
  ...
  function HangupCall() {
    try {
      ...
      if (webphone_api.global.hangupPressedCount < 2) {
        if (
          webphone_api.common.GetNrOfActiveCalls() < 2 &&
          (webphone_api.common.isNull(
            webphone_api.global.waiting_conf_numbers,
          ) ||
            webphone_api.global.waiting_conf_numbers.length < 1) &&
          ...
          webphone_api
            ...
            .attr(
              ...
              "" +
                webphone_api.common.GetElementSource() +
                "images/btn_close_txt.png",
            );
          webphone_api
            .$("#btn_hangup")
            .attr("title", webphone_api.stringres.get("hint_closecall"));
        }
        webphone_api.hangup();
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: HangupCall", err);
    }
  }
  ...
  function AcceptCall(callapi) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: AcceptCall", err);
    }
  }
  ...
  function RejectCall(callapi) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: RejectCall", err);
    }
  }
  ...
  function SendDtmf(numChar) {
    try {
      ...
      if (webphone_api.common.isNull(currNumVal)) {
        currNumVal = "";
      }

      if (currNumVal.length > 18) {
        currNumVal = currNumVal.substring(10, currNumVal.length) + " ";
      }

      webphone_api.$("#numpad_number").html(currNumVal + numChar);
    } catch (err) {
      webphone_api.common.PutToDebugLogException(2, "_call: SendDtmf", err);
    }
  }
  ...
  function CloseCall() {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: CloseCall", err);
    }
  }
  ...
  function UpdateLineButtons() {
    try {
      if (webphone_api.common.IsSDK() === true) {
        return;
      }
      var mlcont = document.getElementById("mlcontainer");
      if (webphone_api.common.isNull(mlcont)) {
        return;
      }

      var ml_btns = document.getElementById("ml_buttons");
      if (webphone_api.common.isNull(ml_btns)) {
        return;
      }

      if (
        webphone_api.common.isNull(webphone_api.global.ep) ||
        webphone_api.global.ep.length < 1
      ) {
        return;
      }
      ...
      var template =
        ...
        webphone_api.stringres.get("line_title") +
        " [LINENR]</span>" +
      ...
      for (var i = 0; i < webphone_api.global.ep.length; i++) {
        ...
        if (
          webphone_api.common.isNull(lntmp) ||
          lntmp.length < 1 ||
          webphone_api.common.IsNumber(lntmp) === false
        ) {
          continue;
        }
        ...
        var btn = webphone_api.common.ReplaceAll(
          template,
          "[LINENR]",
          iline.toString(),
        );
      ...
      if (buttonIds.length > 1) {
        // display buttons only if there are at least 2 lines
        if (mlcont.style.display === "none") {
          mlcont.style.display = "block";
        }
      } else {
        ml_btns.innerHTML = "";
  ...
  function LineCliked(id) {
    try {
      ...
      if (webphone_api.common.isNull(id) || id.indexOf("btn_line_") !== 0) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: LineCliked invalid id: " + id,
        );
        return;
      }
      ...
      webphone_api.common.PutToDebugLog(
        1,
        "EVENT, Line " + line.toString() + " selected by user",
      );
      ...
      for (var i = 0; i < webphone_api.global.ep.length; i++) {
        ...
        if (webphone_api.global.aline == iline) {
          if (automute >= 4) {
            if (item[webphone_api.common.EP_MUTESTATE] == "true") {
              // if is muted
              // call directly to engine API files to be able to pass exact line

              webphone_api.common.PutToDebugLog(
                2,
                "EVENT, EVENT, USER, automute, API_MuteEx, false on line: " +
                  iline +
                  "; dest: " +
                  item[webphone_api.common.EP_DESTNR],
              );
              if (
                webphone_api.common.getuseengine() ===
                webphone_api.global.ENGINE_WEBRTC
              ) {
                webphone_api.webrtcapi.SipToggleMute(
                  false,
                  mutedirection,
                  iline,
                );
              ...
              webphone_api.global.ep[i][webphone_api.common.EP_MUTESTATE] =
                "false";
            }
          }

          if (autohold >= 4) {
            if (item[webphone_api.common.EP_HOLDSTATE] == "true") {
              // if is on hold
              webphone_api.common.PutToDebugLog(
                2,
                "EVENT, EVENT, USER, autohold, API_Hold mainlogic, false on line: " +
                  iline +
                  "; dest: " +
                  item[webphone_api.common.EP_DESTNR],
              );
              if (
                ...
                if (
                  webphone_api.webrtcapi.SipToggleHoldResume(false, iline, 13)
                ) {
          ...
          if (automute >= 4) {
            if (item[webphone_api.common.EP_MUTESTATE] == "false") {
              // if not muted
              webphone_api.common.PutToDebugLog(
                2,
                "EVENT, EVENT, USER, automute, API_MuteEx, true on line: " +
                  iline +
                  "; dest: " +
                  item[webphone_api.common.EP_DESTNR],
              );
          ...
          if (autohold >= 4) {
            if (item[webphone_api.common.EP_HOLDSTATE] == "false") {
              // if not on hold
              webphone_api.common.PutToDebugLog(
                2,
                "EVENT, EVENT, USER, autohold, API_Hold mainlogic, true on line: " +
                  iline +
                  "; dest: " +
                  item[webphone_api.common.EP_DESTNR],
              );
              if (
                ...
                if (
                  webphone_api.webrtcapi.SipToggleHoldResume(true, iline, 14)
                ) {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: LineCliked", err);
    }
  }
  ...
  function NewMultilineCall(phoneNr) {
    try {
      ...
      var template =
        "" +
        '<div id="mlcall_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        ...
        webphone_api.stringres.get("menu_multilinecall") +
        "</h1>" +
        "</div>" +
      ...
      var last_newcall_number = webphone_api.common.GetParameter(
        "last_newcall_number",
      );
      if (
        !webphone_api.common.isNull(last_newcall_number) &&
        last_newcall_number.length > 1
      )
        textBox.value = last_newcall_number;
      if (!webphone_api.common.isNull(phoneNr) && phoneNr.length > 0) {
        textBox.value = phoneNr;
      }
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, call NewMultilineCall ok onclick",
        );
  ...
  function AddCallFunctions(addcallfwd) {
    try {
      ...
      if (
        webphone_api.common.isNull(availableFunc) ||
        availableFunc.length < 3
      ) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: AddCallFunctions no available callfunctions (1)",
        );
        return;
      }
      ...
      if (webphone_api.common.isNull(callfunc)) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: AddCallFunctions no available callfunctions (2)",
        );
        return;
      }
      ...
      if (
        webphone_api.common.IsNumber(videop) &&
        webphone_api.common.CanIUseVideo() &&
        videop < 1
      ) {
        videop = 3;
      ...
      for (var i = 0; i < usage.length; i++) {
        for (var j = i + 1; j < usage.length; j++) {
          ...
          try {
            ...
            webphone_api.common.PutToDebugLogException(
              2,
              "_call AddCallFunctions parseint",
              ein,
            );
          }
      ...
      if (webphone_api.common.isNull(funcArray) || funcArray.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: AddCallFunctions no available callfunctions (3)",
        );
        return;
      }
      ...
      if (webphone_api.global.nrOfCallfunctionsToDisplay === 0) {
        webphone_api.global.nrOfCallfunctionsToDisplay = 5;
      }
      if (webphone_api.global.nrOfCallfunctionsToDisplay > funcArray.length) {
        webphone_api.global.nrOfCallfunctionsToDisplay = funcArray.length;
      }
      ...
      var template =
        ...
        '<img src="' +
        webphone_api.common.GetElementSource() +
        'images/btn_[REPLACESTR]_txt.png" />' +
      ...
      for (var i = 0; i < usageNames.length; i++) {
        ...
        if (
          webphone_api.common.isNull(cfitem) ||
          webphone_api.common.Trim(cfitem).length < 1
        ) {
          continue;
        }
        if (availableFunc.toLowerCase().indexOf(cfitem) < 0) {
          continue;
        }
        ...
        if (currThemeTmp === 22 || currThemeTmp === 23) {
          item = webphone_api.common.ReplaceAll(
            item,
            "btn_[REPLACESTR]_txt.png",
            "btn_" + cfitem + "_txt_grey.png",
          );
          item = webphone_api.common.ReplaceAll(
            item,
            "<button",
        ...
        if (i < webphone_api.global.nrOfCallfunctionsToDisplay - 1) {
          funchtml = funchtml + spacer;
        }
      ...
      webphone_api.$("#btn_callforward").on("click", function (event) {
      ...
      webphone_api.$("#btn_transfer").on("click", function (event) {
        CallfunctionsOnclick("transfer", true);
      });

      webphone_api.$("#btn_numpad").off("click");
      webphone_api.$("#btn_numpad").on("click", function (event) {
        CallfunctionsOnclick("numpad");
      });

      webphone_api.$("#btn_mute").off("click");
      webphone_api.$("#btn_mute").on("click", function (event) {
        CallfunctionsOnclick("mute");
      });

      webphone_api.$("#btn_hold").off("click");
      webphone_api.$("#btn_hold").on("click", function (event) {
        CallfunctionsOnclick("hold");
      });

      webphone_api.$("#btn_speaker").off("click");
      webphone_api.$("#btn_speaker").on("click", function (event) {
        CallfunctionsOnclick("speaker");
      });

      webphone_api.$("#btn_chat").off("click");
      webphone_api.$("#btn_chat").on("click", function (event) {
        CallfunctionsOnclick("chat");
      });

      webphone_api.$("#btn_video").off("click");
      webphone_api.$("#btn_video").on("click", function (event) {
        CallfunctionsOnclick("video");
      });

      webphone_api.$("#btn_more").off("click");
      webphone_api.$("#btn_more").on("click", function (event) {
        CallfunctionsOnclick("more");
      });

      webphone_api
        .$("#btn_callforward")
        .attr("title", webphone_api.stringres.get("hint_callforward"));
      webphone_api
        .$("#btn_conference")
        .attr("title", webphone_api.stringres.get("hint_conference"));
      webphone_api
        .$("#btn_transfer")
        .attr("title", webphone_api.stringres.get("hint_transfer"));
      webphone_api
        .$("#btn_numpad")
        .attr("title", webphone_api.stringres.get("hint_dialpad_dtmf"));
      webphone_api
        .$("#btn_mute")
        .attr("title", webphone_api.stringres.get("hint_mute"));
      webphone_api
        .$("#btn_hold")
        .attr("title", webphone_api.stringres.get("hint_hold"));
      webphone_api
        .$("#btn_speaker")
        .attr("title", webphone_api.stringres.get("hint_speaker"));
      webphone_api
        .$("#btn_chat")
        .attr("title", webphone_api.stringres.get("hint_message"));
      webphone_api
        .$("#btn_video")
        .attr("title", webphone_api.stringres.get("menu_videorecall"));
      webphone_api
        .$("#btn_more")
        .attr("title", webphone_api.stringres.get("hint_more"));
      ...
      if (!webphone_api.common.isNull(mstatus)) {
        if (mutestate === true) {
          if (
            webphone_api.$(mstatus).hasClass("callfunc_status_on") === false
          ) {
      ...
      if (!webphone_api.common.isNull(hstatus)) {
        if (holdstate === true) {
          if (
            webphone_api.$(hstatus).hasClass("callfunc_status_on") === false
          ) {
      ...
      if (count === 0) {
        count = webphone_api.global.nrOfCallfunctionsToDisplay;
      }
      var btnWidth =
        webphone_api.common.GetDeviceWidth() -
        (count - 1) * webphone_api.$(".callfunc_spacer").width();

      btnWidth =
        Math.round(
          ((btnWidth * 100.0) / webphone_api.common.GetDeviceWidth()) * 100,
        ) / 100;
  ...
  function CFUsageClickCount(which) {
    // count the number of clicks on call function buttons
    var lastoop = 0;
    ...
    try {
      ...
      lastoop = 5;
      switch (which) {
        case CLICK_CONFERENCE:
          usageInt[CLICK_CONFERENCE]++;
          return;
        case CLICK_TRANSFER:
          usageInt[CLICK_TRANSFER]++;
          return;
        case CLICK_MUTE:
          usageInt[CLICK_MUTE]++;
          return;
        case CLICK_HOLD:
          ...
          return;
        case CLICK_SPEAKER:
          usageInt[CLICK_SPEAKER]++;
          return;
        case CLICK_NUMAPD:
          usageInt[CLICK_NUMAPD]++;
          return;
        case CLICK_BLUETOOTH:
          usageInt[CLICK_BLUETOOTH]++;
          return;
        case CLICK_CHAT:
          usageInt[CLICK_CHAT]++;
          return;
        case CLICK_VIDEO:
          usageInt[CLICK_VIDEO]++;
          return;
      }
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_call: CFUsageClickCount (" + lastoop.toString() + ")",
        err,
      );
    }
  }

  function CallfunctionsOnclick(func, isTransfButton) {
    // call page -> call function button on click
    try {
      if (webphone_api.common.isNull(func)) {
        return;
      }

      webphone_api.common.PutToDebugLog(
        4,
        "EVENT, _call CallfunctionsOnclick func = " + func,
      );
      ...
      if (
        !webphone_api.common.isNull(status) &&
        func !== "conference" &&
        func !== "transfer" &&
        func !== "chat" &&
        func !== "more" &&
  ...
  function Numpad() {
    ...
    try {
      ...
      if (webphone_api.$("#numpad").css("display") === "none") {
        if (webphone_api.$("#audiodevice_container").is(":visible")) {
          audiowasvisible = true;
        } else {
          audiowasvisible = false;
        }
        if (webphone_api.$("#volumecontrols").is(":visible")) {
          volumewasvisible = true;
        } else {
          volumewasvisible = false;
        }
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Numpad", err);
    }
  }

  function Conference(phoneNr) {
    // popup
    try {
      webphone_api.common.PutToDebugLog(
        1,
        "EVENT, " + webphone_api.stringres.get("initiate_conference"),
      );
      ...
      if (
        ...
        if (
          webphone_api.common.GetParameter("conf_engineswitcheoffered") !==
          "true"
        ) {
          var ep_webrtc = webphone_api.common.StrToInt(
            webphone_api.common.GetParameter2("enginepriority_webrtc"),
          );
          var ep_java = webphone_api.common.StrToInt(
            webphone_api.common.GetParameter2("enginepriority_java"),
          );
          var ep_ns = webphone_api.common.StrToInt(
            webphone_api.common.GetParameter2("enginepriority_ns"),
          );

          if (
            ep_ns > 0 &&
            ep_webrtc - ep_ns < 3 &&
            webphone_api.common.CanIUseService() === true
          ) {
            webphone_api.common.EngineSwitchConference(
              "ns",
              phoneNr,
              Conference,
            );
          ...
          if (
            ep_java > 0 &&
            ep_webrtc - ep_java < 3 &&
            webphone_api.common.CanIUseApplet() === true
          ) {
            webphone_api.common.EngineSwitchConference(
              "java",
              phoneNr,
          ...
          webphone_api.common.PutToDebugLog(
            2,
            "ERROR, _call Conference engine switch already offered: " +
              webphone_api.common.getuseengine(),
          );
        }
      }
      ...
      if (webphone_api.common.GetNrOfActiveCalls() > 1) {
        for (var i = 0; i < webphone_api.global.ep.length; i++) {
          if (
            webphone_api.common.isNull(webphone_api.global.ep[i]) ||
            webphone_api.global.ep[webphone_api.common.EP_FLAGDEL] === "true"
          ) {
            continue;
          }

          var ln = webphone_api.common.StrToInt(
            webphone_api.global.ep[i][webphone_api.common.EP_LINE],
          );

          if (ln !== webphone_api.global.aline) {
            // we found another active call
            var nr = webphone_api.global.ep[i][webphone_api.common.EP_DESTNR];
            if (!webphone_api.common.isNull(nr) && nr.length > 0) {
              if (
                webphone_api.common.IsMizuServerOrGateway() === true &&
                IsConferenceRoom() === true
              ) {
                // means it's conference rooms, so just send invites via chat
                ...
                webphone_api.common.SendConferenceInvites(
                  nr,
                  ep[webphone_api.common.EP_DESTNR],
                );

                webphone_api.common.PutToDebugLog(
                  2,
                  "EVENT, _call: Conference, multiline conference: " +
                    nr +
                    " AND " +
                    ep[webphone_api.common.EP_DESTNR],
                );
                ...
                webphone_api.common.ShowToast(
                  webphone_api.stringres.get("interconnect_conf"),
                );
                ...
                webphone_api.common.PutToDebugLog(
                  2,
                  "EVENT, _call: Conference, multiline conference: " + nr,
                );
              }
      ...
      if (
        webphone_api.common.GetNrOfActiveCalls() > 1 &&
        (webphone_api.common.getuseengine() ===
          webphone_api.global.ENGINE_SERVICE ||
          webphone_api.common.getuseengine() ===
            webphone_api.global.ENGINE_JAVA ||
        ...
        interconnectHtml =
          "<br />" +
          '<button id="btn_interconnect_conf" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" style="font-size: .9em">' +
          webphone_api.stringres.get("interconnect") +
          "</button>";
      }

      var template =
        "" +
        '<div id="conference_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("conference_title") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content adialog_btn_nexttoinput">' +
        "<span>" +
      ...
      var lastConferenceNumber = webphone_api.common.GetParameter(
        "last_conference_number",
      );

      if (
        !webphone_api.common.isNull(lastConferenceNumber) &&
        lastConferenceNumber.length > 1
      ) {
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        ...
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, call Conference ok onclick (" +
            webphone_api.common.getuseengine() +
            "): " +
            textboxval,
        );
      ...
      webphone_api.$("#btn_interconnect_conf").on("click", function (event) {
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, conference interconnect on click",
        );
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Conference", err);
    }
  }

  function Callforward(phoneNr) {
    // popup
    try {
      webphone_api.common.PutToDebugLog(
        1,
        "EVENT, " + webphone_api.stringres.get("initiate_callforward"),
      );
      ...
      var template =
        "" +
        '<div id="callforward_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' +
        popupWidth +
        'px;">' +
        '<div data-role="header" data-theme="b">' +
        '<a href="javascript:;" data-role="button" data-icon="delete" data-iconpos="notext" class="ui-btn-right closePopup">Close</a>' +
        '<h1 class="adialog_title">' +
        webphone_api.stringres.get("callforward_title") +
        "</h1>" +
        "</div>" +
        '<div role="main" class="ui-content adialog_content adialog_btn_nexttoinput">' +
        "<span>" +
      ...
      webphone_api.$("#adialog_positive").on("click", function (event) {
        webphone_api.common.PutToDebugLog(
          5,
          "EVENT, call Callforward ok onclick",
        );
        var textboxval = webphone_api.common.Trim(textBox.value);
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Callforward", err);
    }
  }
  ...
  function SpecialTransfer(id) {
    try {
      webphone_api.common.PutToDebugLog(
        5,
        "EVENT, _call SpecialTransfer" + id.toString(),
      );
      webphone_api.common.SaveParameter(
        "transfertype",
        webphone_api.common.GetParameter("transfertype" + id),
      );
      webphone_api.common.SaveParameter(
        "transfwithreplace",
        webphone_api.common.GetParameter("transfwithreplace" + id),
      );
      webphone_api.common.SaveParameter(
        "allowreplace",
        webphone_api.common.GetParameter("allowreplace" + id),
      );
      webphone_api.common.SaveParameter(
        "discontransfer",
        webphone_api.common.GetParameter("discontransfer" + id),
      );
      webphone_api.common.SaveParameter(
        "disconincomingrefer",
        webphone_api.common.GetParameter("disconincomingrefer" + id),
      );
      webphone_api.common.SaveParameter(
        "inversetransfer",
        webphone_api.common.GetParameter("inversetransfer" + id),
      );
      webphone_api.common.SaveParameter(
        "transferdelay",
        webphone_api.common.GetParameter("transferdelay" + id),
      );
      webphone_api.common.SaveParameter(
        "newdialogforrefer",
        webphone_api.common.GetParameter("newdialogforrefer" + id),
      );
      webphone_api.common.SaveParameter(
        "useserverdomainforrefer",
        webphone_api.common.GetParameter("useserverdomainforrefer" + id),
      );
      webphone_api.common.SaveParameter(
        "holdontransfer",
        webphone_api.common.GetParameter("holdontransfer" + id),
      );
  ...
  function BeforeTransfer(phoneNr) {
    try {
      webphone_api.common.PutToDebugLog(
        5,
        "EVENT, _call BeforeTransfer" + phoneNr,
      );
      if (
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername1"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername2"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername3"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername4"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername5"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername6"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername7"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername8"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername9"),
        ).length > 0 ||
        webphone_api.common.Trim(
          webphone_api.common.GetParameter("transfername10"),
        ).length > 0
      ) {
        // open menu
        webphone_api.$("#btn_call_menu").click();
  ...
  function Mute() {
    ...
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Mute", err);
    }
    return false;
  }

  function Hold() {
    // :boolean  handle Hold - onClick
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Hold", err);
    }
    return false;
  }
  ...
  function Chat() {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: Chat", err);
    }
  }
  ...
  function CreateOptionsMenu(menuId) {
    ...
    try {
      ...
      if (webphone_api.common.isNull(menuId) || menuId.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: CreateOptionsMenu menuid null",
        );
        return;
      }
      ...
      if (webphone_api.$(menuId).length <= 0) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: CreateOptionsMenu can't get reference to Menu",
        );
        return;
      }
      ...
      if (
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _call: CreateOptionsMenu no available callfunctions (1)",
        );
        return;
      }
      ...
      if (availableFunc.indexOf("numpad") >= 0) {
        ...
        if (webphone_api.$("#numpad").is(":visible")) {
          numpadTitle = webphone_api.stringres.get("menu_numpad_hide");
        }
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_CALL_NUMPAD +
              '"><a data-rel="back">' +
              numpadTitle +
              "</a></li>",
          )
      ...
      if (featureset > 5) {
        if (
          availableFunc.indexOf("conference") >= 0 &&
          (webphone_api.common.IsWindowsSoftphone() === true ||
            webphone_api.common.getuseengine() ===
              webphone_api.global.ENGINE_JAVA ||
            webphone_api.common.getuseengine() ===
          ...
          webphone_api
            ...
            .append(
              '<li id="' +
                MENUITEM_CALL_CONFERENCE +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("menu_conference") +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      if (availableFunc.indexOf("chat") >= 0) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_MESSAGE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_message") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.Glt() === true) {
        ...
        if (
          featureset > 0 &&
          availableFunc.indexOf("transfer") >= 0 &&
          (webphone_api.global.checkIfCallActive === true ||
            webphone_api.common.GetNrOfActiveCalls() > 0)
        ) {
          if (
            webphone_api.common.Trim(
              webphone_api.common.GetParameter("transfername1"),
            ...
            webphone_api
              ...
              .append(
                '<li id="' +
                  ...
                  '"><a data-rel="back">' +
                  webphone_api.stringres.get("menu_transfer") +
                  "</a></li>",
              )
              .listview("refresh");
          }
        ...
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_MUTE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_mute") +
              "</a></li>",
          )
          .listview("refresh");
      }
        ...
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_HOLD +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_hold") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.CanIUseVideo() === true) {
        ...
        if (webphone_api.common.IsCExt() < 1) {
          webphone_api
            ...
            .append(
              '<li id="' +
                MENUITEM_RECALL_VIDEO +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("menu_videorecall") +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      if (webphone_api.common.Glt() === true)
        if (
          featureset > 5 &&
          availableFunc.indexOf("callforward") >= 0 &&
          showcallfwd === true
        ) {
          //OPSEND
          webphone_api
            ...
            .append(
              '<li id="' +
                MENUITEM_CALL_CALLFORWARD +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("menu_callforward") +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      if (featureset > 0 && availableFunc.indexOf("speaker") >= 0) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_SPEAKER +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_speaker") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (showignore === true) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_IGNORE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_ignore") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.IsWindowsSoftphone() === true && callmode > 0) {
        if (
          ...
          webphone_api
            ...
            .append(
              '<li id="' +
                MENUITEM_EXIT_VIDEOMODE +
                '"><a data-rel="back">' +
                webphone_api.stringres.get("menu_exit_videomode") +
                "</a></li>",
            )
            .listview("refresh");
        }
      ...
      if (webphone_api.$("#mline_layout").is(":visible")) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_ACCEPT_HOLD +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_accept_hold") +
              "</a></li>",
          )
          .listview("refresh");
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_ACCEPT_END +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_accept_end") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.isNull(cpnr) || cpnr.length < 0) {
        cpnr = webphone_api.common.GetParameter2("callparknumber");
      }
      if (cpnr.length > 0) {
        webphone_api
          .$(menuId)
          .append(
            '<li id="' +
              MENUITEM_CALLPARK +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_callpark") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (
        ...
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_AUDIO_DEVICE +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_audiodeviceshow") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (callmode === 1) {
        webphone_api
          ...
          .append(
            '<li id="' +
              MENUITEM_CALL_AUDIO_ONLY +
              '"><a data-rel="back">' +
              webphone_api.stringres.get("menu_mute_video") +
              "</a></li>",
          )
          .listview("refresh");
      }
      ...
      if (webphone_api.common.Glcr() === true) {
        ...
        if (
          featureset > 0 &&
          webphone_api.common.GetParameter("voicerecupload").length > 0
        ) {
          if (IsRecStarted(GetActiveLinePeer()) === true) {
            webphone_api
              ...
              .append(
                '<li id="' +
                  MENUITEM_RECORD_CALL +
                  '"><a data-rel="back">' +
                  webphone_api.stringres.get("menu_stop_record_call") +
                  "</a></li>",
              )
              .listview("refresh");
          } else {
            webphone_api
              ...
              .append(
                '<li id="' +
                  MENUITEM_RECORD_CALL +
                  '"><a data-rel="back">' +
                  webphone_api.stringres.get("menu_record_call") +
                  "</a></li>",
              )
              .listview("refresh");
          }
  ...
  function GetActiveLinePeer() {
    try {
      if (
        !webphone_api.common.isNull(webphone_api.global.ep) ||
        webphone_api.global.ep.length > 0
      ) {
        for (var i = 0; i < webphone_api.global.ep.length; i++) {
          if (
            webphone_api.common.isNull(webphone_api.global.ep[i]) ||
  ...
  function IsRecStarted(peer) {
    try {
      if (webphone_api.common.isNull(peer) || peer.length < 1) {
        return false;
      }
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: IsRecStarted", err);
    }
    return false;
  }
  ...
  function StartRecording(peer) {
    ...
    try {
      ...
      webphone_api.voicerecord(
        true,
        webphone_api.common.GetParameter("voicerecftp_addr"),
      );
  ...
  function VideoRecall() {
    try {
      if (callmode > 0) {
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "WARNING, _call VideoRecall this is already a video call",
        );
        return;
      }
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: VideoRecall", err);
    }
  }
  ...
  function CallPark() {
    try {
      ...
      webphone_api.common.PutToDebugLog(
        3,
        "EVENT, call CallPark onclick: " + cpnr,
      );
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: CallPark", err);
    }
  }
  ...
  function IsConferenceRoom() {
    // check if called number is a conference room number
    try {
      if (webphone_api.common.isNull(callnumber) || callnumber.length < 0) {
        return false;
      }
  ...
  function onStop(event) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_call: onStop", err);
    }
  }
