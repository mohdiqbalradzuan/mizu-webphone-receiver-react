...
webphone_api._newuser = (function () {
  function onCreate(event) {
    ...
    try {
      ...
      webphone_api.$("#btn_newuser_menu").on("click", function () {
        CreateOptionsMenu("#newuser_menu_ul");
      });
      webphone_api
        .$("#btn_newuser_menu")
        .attr("title", webphone_api.stringres.get("hint_menu"));

      webphone_api.$("#btn_create_newuser").on("click", function () {
        CreateUser();
      });
      ...
      webphone_api.common.PutToDebugLogException(2, "_newuser: onCreate", err);
    }
  }
  ...
  function onStart(event) {
    try {
      ...
      if (
        !webphone_api.common.isNull(document.getElementById("newuser_title"))
      ) {
        document.getElementById("newuser_title").innerHTML =
          webphone_api.stringres.get("newuser_title");
      }
      webphone_api
        .$("#newuser_title")
      ...
      if (
        !webphone_api.common.isNull(document.getElementById("newuser_btnback"))
      ) {
        document.getElementById("newuser_btnback").innerHTML =
          "<b>&LT;</b>&nbsp;" + webphone_api.stringres.get("go_back_btn_txt");
      }

      if (
        !webphone_api.common.isNull(
          document.getElementById("btn_create_newuser"),
        )
      ) {
        document.getElementById("btn_create_newuser").innerHTML =
          webphone_api.stringres.get("btn_create");
      }

      if (
        !webphone_api.common.isNull(
          document.getElementById("btn_cancel_newuser"),
        )
      ) {
        document.getElementById("btn_cancel_newuser").innerHTML =
      ...
      if (!webphone_api.common.isNull(pwdField)) {
        var autogenpassword = webphone_api.common.GetParameterInt(
          "autogenpassword",
          0,
        );
        if (autogenpassword > 0) {
          ...
          webphone_api.common.PutToDebugLog(
            4,
            "EVENT, _newuser autogenpassword: " + pwd,
          );

          pwdField.value = pwd;

          if (autogenpassword > 1) {
      ...
      webphone_api.common.PutToDebugLogException(2, "_newuser: onStart", err);
    }
  }

  function MeasureNewuser() {
    ...
    try {
      ...
      webphone_api
        ...
        .css(
          ...
          webphone_api.common.HoverCalc(
            webphone_api.common.getBgColor("#page_newuser"),
            -30,
          ),
        );
      ...
      if (webphone_api.common.NuIsWebPage()) {
        var heightBrowser =
          ...
          webphone_api.$("#newuser_header").height();
        ...
        webphone_api
          .$("#iframe_nubrowser")
          .width(webphone_api.common.GetDeviceWidth());
        webphone_api.$("#iframe_nubrowser").height(heightBrowser - 5);
      } else {
        var heightTemp =
          webphone_api.common.GetDeviceHeight() -
          webphone_api.$("#newuser_header").height() -
          webphone_api.$("#newuser_footer").height();
  ...
  function PopulateData() {
    try {
      ...
      if (webphone_api.common.isNull(reguri) || reguri.length < 1) {
        reguri = webphone_api.common.GetParameter("newuserurl");
      }
      if (webphone_api.common.isNull(reguri)) {
        reguri = "";
      }
      ...
      if (webphone_api.common.isNull(nuLabel) || nuLabel.length < 2) {
        nuLabel = webphone_api.stringres.get("nu_username");
      }
      webphone_api.$("#label_nu_username").html("*" + nuLabel);
      webphone_api
        .$("#label_nu_password")
        .html("*" + webphone_api.stringres.get("nu_password"));
      webphone_api
        .$("#label_nu_passwordverify")
        .html("*" + webphone_api.stringres.get("nu_password_verify"));
      webphone_api
        .$("#label_nu_email")
        .html(webphone_api.stringres.get("nu_email"));
      webphone_api
        .$("#label_nu_fullname")
        .html(webphone_api.stringres.get("nu_fullname"));
      webphone_api
        .$("#label_nu_firstname")
        .html(webphone_api.stringres.get("nu_firstname"));
      webphone_api
        .$("#label_nu_lastname")
        .html(webphone_api.stringres.get("nu_lastname"));
      webphone_api
        .$("#label_nu_phone")
        .html(webphone_api.stringres.get("nu_phone"));
      webphone_api
        .$("#label_nu_address")
        .html(webphone_api.stringres.get("nu_address"));

      webphone_api
        .$("#label_nu_country")
        .html(webphone_api.stringres.get("nu_country"));
      webphone_api
        .$("#label_nu_birthday")
        .html(webphone_api.stringres.get("nu_birthday"));
      webphone_api
        .$("#label_nu_gender")
        .html(webphone_api.stringres.get("nu_gender"));
      webphone_api
        .$("#label_nu_fpq")
        .html(webphone_api.stringres.get("nu_fpq"));
      webphone_api
        .$("#label_nu_fpa")
        .html(webphone_api.stringres.get("nu_fpa"));

      // dynamically get form fields
      var newuserform = webphone_api.common.GetConfig("newuserform");
      var newusercountrylist =
        webphone_api.common.GetConfig("newusercountrylist");
      if (!webphone_api.common.isNull(newuserform) && newuserform.length > 0) {
        if (
          !webphone_api.common.isNull(newusercountrylist) &&
          newusercountrylist.length > 4
        ) {
          ...
          reqtimer = setInterval(function () // waiting for countrylist
          {
            ...
            if (reqmaxllop > 600) {
              reqmaxllop = 0;
              if (!webphone_api.common.isNull(reqtimer)) {
                clearInterval(reqtimer);
              }
              reqtimer = null;
              webphone_api.common.PutToDebugLog(
                2,
                "ERROR, newuser: PopulateData: waiting for countrylist timeouted",
              );
              return;
            }
        ...
        if (reguri.length > 0) {
          var dispFields = webphone_api.common.GetUrlParamVal(
            reguri,
            "DISPLAYFIELDS",
          );
          if (
            !webphone_api.common.isNull(dispFields) &&
            dispFields.length > 0
          ) {
            ...
            if (dispArr.indexOf("username") >= 0) {
              document.getElementById("nu_username_container").style.display =
                "block";
            }
            if (dispArr.indexOf("password") >= 0) {
              document.getElementById("nu_password_container").style.display =
                "block";
            }
            if (dispArr.indexOf("passwordverify") >= 0) {
              document.getElementById(
                "nu_passwordverify_container",
              ).style.display = "block";
            }
            if (dispArr.indexOf("firstname") >= 0) {
              document.getElementById("nu_firstname_container").style.display =
                "block";
            }
            if (dispArr.indexOf("lastname") >= 0) {
              document.getElementById("nu_lastname_container").style.display =
                "block";
            }
            if (dispArr.indexOf("name") >= 0) {
              document.getElementById("nu_fullname_container").style.display =
                "block";
            }
            if (dispArr.indexOf("mail") >= 0 || dispArr.indexOf("email") >= 0) {
              document.getElementById("nu_email_container").style.display =
                "block";
            }
            if (dispArr.indexOf("phone") >= 0) {
              document.getElementById("nu_phone_container").style.display =
                "block";
            }
            if (dispArr.indexOf("address") >= 0) {
              document.getElementById("nu_address_container").style.display =
                "block";
            }
            if (dispArr.indexOf("country") >= 0) {
              document.getElementById("nu_country_container").style.display =
                "block";
            }
            if (dispArr.indexOf("gender") >= 0) {
              document.getElementById("nu_gender_container").style.display =
                "block";
            }
            if (dispArr.indexOf("forgotpasswordquestion") >= 0) {
              document.getElementById("nu_fpq_container").style.display =
                "block";
            }
            if (dispArr.indexOf("forgotpasswordanswer") >= 0) {
              document.getElementById("nu_fpa_container").style.display =
                "block";
            }

            var extraLabel = webphone_api.common.GetUrlParamVal(
              reguri,
              "EXTRAFIELDCAPTION",
            );
            var extraKey = webphone_api.common.GetUrlParamVal(
              reguri,
              "EXTRAFIELDKEY",
            );

            if (
              !webphone_api.common.isNull(extraLabel) &&
              extraLabel.length > 0 &&
              !webphone_api.common.isNull(extraKey) &&
              extraKey.length > 0
            ) {
              document.getElementById("nu_extra_container").style.display =
                "block";
            ...
            if (reguri.indexOf("BIRTHDAY") >= 0) {
              document.getElementById("nu_birthday_container").style.display =
                "block";
            }
  ...
  function OpenWebPageNU(url) {
    try {
      if (webphone_api.common.isNull(url) || url.length < 3) {
        webphone_api.common.PutToDebugLog(
          3,
          "ERROR, _newuser no url to load: " + url,
        );
        return;
      }
      ...
      if (
        ...
        webphone_api.common.IsHttps() === true
      ) {
        window.open(
          url,
          "_blank",
      ...
      var height = Math.floor(
        webphone_api.$("#page_newuser_content").height() - 5,
      );
      ...
      if (pos > 0) {
        ...
        if (!webphone_api.common.isNull(pdataStr) && pdataStr.length > 0) {
          ...
          if (webphone_api.common.isNull(pdata)) {
            pdata = [];
          }
        }
        ...
        for (var i = 0; i < pdata.length; i++) {
          if (
            webphone_api.common.isNull(pdata[i]) ||
            pdata[i].length < 2 ||
            pdata[i].indexOf("=") < 1
          ) {
            continue;
          ...
          if (
            webphone_api.common.isNull(name) ||
            name.length < 1 ||
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, OpenWebPageNU, new user POST url in iframe: " + purl,
        );

        iframe =
          '<form id="internalb_post" target="iframe_nubrowser" method="post" action="' +
          purl +
          '" style="margin: 0; padding: 0;">' +
          pdataInput +
          "</form>" +
          '<iframe  allow="microphone *; camera *; autoplay *" allowfullscreen="true" frameborder="0" width="' +
          width +
          '" height="' +
          height +
          '" name="iframe_nubrowser" id="iframe_nubrowser" style="margin:0px; padding:0px;" sandbox="allow-same-origin allow-scripts allow-popups allow-forms allow-top-navigation allow-modals"></iframe>' +
        ...
        webphone_api.common.PutToDebugLog(
          2,
          "EVENT, OpenWebPageNU, new user GET url in iframe: " + url,
        );
    ...
    try {
      ...
      if (!webphone_api.common.isNull(newuserform) && newuserform.length > 0) {
        ...
        for (var i = 0; i < formf.length; i++) {
          item = formf[i];
          if (webphone_api.common.isNull(item) || item.length < 4) {
            continue;
          }
          ...
          if (webphone_api.common.isNull(type)) {
            type = "";
          }
          type = type.toString();
          ...
          if (type.length < 1 || type === "text" || type === "email") {
            ...
            if (
              ...
              !webphone_api.common.isNull(value) &&
              value.length > 0 &&
              !webphone_api.common.isNull(countryNameL) &&
              countryNameL.length > 0 &&
              !webphone_api.common.isNull(countryCodeL) &&
              countryCodeL.length > 0
            ) {
              for (var j = 0; j < countryNameL.length; j++) {
                if (countryNameL[j] === value && countryCodeL.length > j) {
                  ...
                  webphone_api.common.PutToDebugLog(
                    4,
                    "EVENT, _newuser create-account with country: " + value,
                  );
                }
              }
            }
          ...
          if (webphone_api.common.isNull(mandatory)) {
            mandatory = "";
          }
          mandatory = mandatory.toString();
          if (
            value.length < 1 &&
            !webphone_api.common.isNull(mandatory) &&
            mandatory.length > 0
          ) {
            mandatory = mandatory.toLowerCase();
            if (
              mandatory.indexOf("yes") >= 0 ||
              mandatory.indexOf("true") >= 0 ||
              mandatory.indexOf("1") >= 0
            ) {
              webphone_api.common.ShowToast(
                webphone_api.stringres.get("newuser_pleaseenter") +
                  " " +
                  dispname,
              );
              return;
          ...
          // handle validation
          if (webphone_api.common.isNull(validate)) {
            validate = "";
          }
          validate = validate.toString();
          validate = validate.toLowerCase();
          if (
            validate.indexOf("yes") >= 0 ||
            validate.indexOf("true") >= 0 ||
            validate.indexOf("1") >= 0 ||
            validate.indexOf("mail") >= 0
          ) {
            var isvalid = true;
            // if email
            ...
            // for username, password
              ...
              validate.indexOf("user") >= 0 ||
              name.indexOf("user") >= 0 ||
              validate.indexOf("password") >= 0 ||
              name.indexOf("password") >= 0
            ) {
              if (
                webphone_api.common.isNull(value.match("^[A-Za-z0-9_-]{2,40}$"))
              ) {
                isvalid = false;
              }
            }
            ...
            if (isvalid === false) {
              webphone_api.common.ShowToast(
                webphone_api.stringres.get("newuser_invalid") + " " + dispname,
              );
              return;
            }
          }
        ...
        if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
          // favafone // add extra parameters
          var pname = webphone_api.platform.name;
          var pver = webphone_api.platform.version;

          if (
            webphone_api.common.isNull(pname) ||
            webphone_api.common.GetOs() === "Android"
          ) {
            pname = webphone_api.common.GetBrowser();
          }
          if (webphone_api.common.isNull(pver)) {
            pver = webphone_api.common.GetBrowserVersion();
          }
          ...
          var devparamval =
            "version_name:" +
            webphone_api.common.GetVersionStr() +
            "-version_code:" +
            webphone_api.global.code_version +
            "-os_version:" +
            curr_os +
            "-make:" +
            pname +
      ...
      if (webphone_api.common.isNull(username)) {
        username = "";
      } else {
        username = webphone_api.common.Trim(username);
      }
      if (webphone_api.common.isNull(password)) {
        password = "";
      } else {
        password = webphone_api.common.Trim(password);
      }
      ...
      if (webphone_api.common.isNull(firstName)) {
        firstName = "";
      } else {
        firstName = webphone_api.common.Trim(firstName);
      }
      if (webphone_api.common.isNull(lastName)) {
        lastName = "";
      } else {
        lastName = webphone_api.common.Trim(lastName);
      }
      if (webphone_api.common.isNull(phone)) {
        phone = "";
      } else {
        phone = webphone_api.common.Trim(phone);
      }
      if (webphone_api.common.isNull(address)) {
        address = "";
      } else {
        address = webphone_api.common.Trim(username);
      }

      if (webphone_api.common.isNull(country)) {
        country = "";
      } else {
        country = webphone_api.common.Trim(country);
      }
      if (webphone_api.common.isNull(birthday)) {
        birthday = "";
      } else {
        birthday = webphone_api.common.Trim(birthday);
      }
      if (webphone_api.common.isNull(gender)) {
        gender = "";
      } else {
        gender = webphone_api.common.Trim(gender);
      }
      if (webphone_api.common.isNull(fpq)) {
        fpq = "";
      } else {
        fpq = webphone_api.common.Trim(fpq);
      }
      if (webphone_api.common.isNull(fpa)) {
        fpa = "";
      } else {
        fpa = webphone_api.common.Trim(fpa);
      }
      if (webphone_api.common.isNull(extra)) {
        extra = "";
      } else {
        extra = webphone_api.common.Trim(extra);
      }
      ...
      if (
        ...
        if (webphone_api.common.isNull(username) || username.length < 1) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_8"),
          );
          return;
        } else if (username.length < webphone_api.common.MIN_USR_PWD_LENGHT) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_13") +
              " " +
              webphone_api.common.MIN_USR_PWD_LENGHT,
          );
          return;
        } else if (
          webphone_api.common.isNull(
            username.match("^[A-Za-z0-9_-]{2,120}$"),
          ) ||
          username.match("^[A-Za-z0-9_-]{2,120}$")[0].length < 1
        ) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_14"),
          );
          return;
        }
      }
      ...
      if (
        ...
        if (webphone_api.common.isNull(password) || password.length < 1) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_9"),
          );
          return;
        } else if (password.length < webphone_api.common.MIN_USR_PWD_LENGHT) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_15") +
              " " +
              webphone_api.common.MIN_USR_PWD_LENGHT,
          );
          return;
          ...
          webphone_api.common.isNull(
            password.match("^[A-Za-z0-9_-]{2,120}$"),
          ) ||
          password.match("^[A-Za-z0-9_-]{2,120}$")[0].length < 1
        ) {
          webphone_api.common.ShowToast(
            webphone_api.stringres.get("err_msg_16"),
          );
          return;
        }
      }
      ...
      if (
        ...
        if (phone.length > 0) {
          if (phone.length < 5) {
            webphone_api.common.ShowToast(
              webphone_api.stringres.get("err_msg_19"),
            );
            return;
          } else if (
            webphone_api.common.isNull(phone.match("^[0-9+]{3,25}$")) ||
            phone.match("^[0-9+]{3,25}$")[0].length < 1
          ) {
            webphone_api.common.ShowToast(
              webphone_api.stringres.get("err_msg_19"),
            );
      ...
      if (!webphone_api.common.isNull(email) && email.length > 0) {
        webphone_api.common.SaveParameter("email", email);
      }
      if (!webphone_api.common.isNull(fullName) && fullName.length > 0) {
        webphone_api.common.SaveParameter("displayname", fullName);
      }

      if (!webphone_api.common.isNull(username) && username.length > 0) {
        webphone_api.common.SaveParameter("sipusername", username);
      }
      if (!webphone_api.common.isNull(password) && password.length > 0) {
        webphone_api.common.SaveParameter("password", password);
      }
      ...
      webphone_api.common.PutToDebugLog(
        4,
        "EVENT, _newuser CreateUser uri: " + reguri,
      );
    } catch (err) {
      webphone_api.common.PutToDebugLogException(
        2,
    ...
    try {
      if (actionHandler === "newuserreg") {
        if (resp.toLowerCase().indexOf("error") >= 0) {
          webphone_api.common.PutToDebugLog(
            2,
            "ERROR, HttpResponseHandler action: newuserreg, error: " + resp,
          );
        }

        var startverify = false;
        if (GetUriSecondNU().length > 3) {
          // (smsverify_answer) means start_smsverify
          startverify = true;
        }
        ...
        var errorstring = webphone_api.common.GetUrlParamVal(
          uri,
          "ERRORSTRING",
        );
        ...
        var msgtodisplay = webphone_api.common.GetJsonParamVal(
          resp,
          "message:",
        );
        if (
          webphone_api.common.isNull(msgtodisplay) ||
          msgtodisplay.length < 1
        ) {
          msgtodisplay = webphone_api.common.GetJsonParamVal(resp, "msg:");
        }
        if (
          webphone_api.common.isNull(msgtodisplay) ||
          webphone_api.common.Trim(msgtodisplay).length < 1
        ) {
          msgtodisplay = resp;
        }
        ...
        if (
          resp.length < 1 ||
          tempresp.indexOf("error") >= 0 ||
          tempresp.indexOf(errorstring) >= 0
        ) {
          webphone_api.common.PutToDebugLog(
            2,
            "ERROR, New user creation failed: " + resp,
          );
        ...
        if (webphone_api.common.isNull(success)) {
          success = "";
        }
        ...
        if (success.length > 0) {
          if (tempresp.indexOf(success) >= 0) {
            ...
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, New user creation SUCCEDED" + resp,
            );
          } else {
            webphone_api.common.PutToDebugLog(1, "ERROR," + msgtodisplay);
            webphone_api.common.PutToDebugLog(
              2,
              "ERROR, New user creation failed, does not contain SUCCESSSTRING" +
                resp,
            );
            if (msgtodisplay.length > 0)
              webphone_api.common.ShowToast(msgtodisplay);
        ...
        if (webphone_api.common.isNull(userID) || userID.length < 1) {
          userID = webphone_api.common.GetJsonParamVal(resp, "userid:");
        }
        ...
        if (
          email_begin.length > 0 &&
          email_end.length > 0 &&
          resp.indexOf(email_begin) >= 0 &&
          resp.indexOf(email_end) > 0
        ) {
          var email = resp.substring(
            resp.indexOf(email_begin) + email_begin.length,
            resp.indexOf(email_end),
          );

          webphone_api.common.SaveParameter("email", email);
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW email saved: " + email,
          );
        }
        ...
        if (
          name_begin.length > 0 &&
          name_end.length > 0 &&
          resp.indexOf(name_begin) >= 0 &&
          resp.indexOf(name_end) > 0
        ) {
          var name = resp.substring(
            resp.indexOf(name_begin) + name_begin.length,
            resp.indexOf(name_end),
          );

          webphone_api.common.SaveParameter("name", name);
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW name saved: " + name,
          );
        }

        if (
          callerid_begin.length > 0 &&
          callerid_end.length > 0 &&
          resp.indexOf(callerid_begin) >= 0 &&
          resp.indexOf(callerid_end) > 0
        ) {
          var callerid = resp.substring(
            resp.indexOf(callerid_begin) + callerid_begin.length,
            resp.indexOf(callerid_end),
          );

          webphone_api.common.SaveParameter("username", callerid);
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW callerid saved: " +
              callerid,
          );
        }

        if (
          userid_begin.length > 0 &&
          userid_end.length > 0 &&
          resp.indexOf(userid_begin) >= 0 &&
          resp.indexOf(userid_end) > 0
        ) {
          var userid = resp.substring(
            resp.indexOf(userid_begin) + userid_begin.length,
            resp.indexOf(userid_end),
          );

          webphone_api.common.SaveParameter("userid", userid);
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW userid saved: " +
              userid,
          );
        }

        if (
          username_begin.length > 0 &&
          username_end.length > 0 &&
          resp.indexOf(username_begin) >= 0 &&
          resp.indexOf(username_end) > 0
        ) {
          usr = resp.substring(
            resp.indexOf(username_begin) + username_begin.length,
            resp.indexOf(username_end),
          );
        }

        if (
          password_begin.length > 0 &&
          password_end.length > 0 &&
          resp.indexOf(password_begin) >= 0 &&
          resp.indexOf(password_end) > 0
        ) {
          pwd = resp.substring(
            resp.indexOf(password_begin) + password_begin.length,
            resp.indexOf(password_end),
          );
        }
        ...
        if (webphone_api.common.isNull(usr) || usr.length < 1) {
          ...
          if (webphone_api.common.isNull(usr) || usr.length < 1) {
            usr = webphone_api.common.GetJsonParamVal(resp, "sipusername");
          }
          if (webphone_api.common.isNull(usr) || usr.length < 1) {
            usr = webphone_api.common.GetJsonParamVal(resp, "username");
          }
          if (webphone_api.common.isNull(usr)) {
            usr = "";
          }
        }
        ...
        if (webphone_api.common.isNull(pwd) || pwd.length < 1) {
          ...
          if (webphone_api.common.isNull(pwd) || pwd.length < 1) {
            pwd = webphone_api.common.GetJsonParamVal(resp, "sippassword");
          }
          if (webphone_api.common.isNull(pwd) || pwd.length < 1) {
            pwd = webphone_api.common.GetJsonParamVal(resp, "password");
          }
          if (webphone_api.common.isNull(pwd)) {
            pwd = "";
          }
        }
        ...
        if (startverify === true) {
          ...
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW username saved: " +
              usr,
          );
        }
        if (startverify === true) {
          ...
          webphone_api.common.PutToDebugLog(
            2,
            "EVENT,newusersignup VerifyThreadHandler NEW password saved: " +
              pwd,
          );
        }
        ...
        if (startverify === true) {
          ...
          webphone_api.global.intentsmscodeverify[2] =
            "smsverify_answer=" + resp;
          webphone_api.global.intentsmscodeverify[2] =
            "smsverify_userid=" + userID;

          webphone_api.$.mobile.changePage("#page_smscodeverify", {
            transition: "pop",
            role: "page",
          });
        } else {
          ...
          if (
            ...
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, newusersignup threadHandler display status message: " +
                msgtodisplay,
            );
            webphone_api.common.ShowToast(msgtodisplay);
          }
        ...
        if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
          ...
          if (!webphone_api.common.isNull(error) && error.length > 0) {
            webphone_api.common.PutToDebugLog(
              3,
              "ERROR, newuserreg get countrylist httpresponsehandler rec error: " +
                error,
            );
          ...
          if (webphone_api.common.isNull(jarray) || jarray.length < 1) {
            webphone_api.common.PutToDebugLog(
              3,
              "ERROR, newuserreg get countrylist httpresponsehandler data is NULL",
            );
            webphone_api.common.ShowToast("Can't load country list.");
            return;
          }
          ...
          for (var i = 0; i < jarray.length; i++) {
            jobj = jarray[i];
            if (webphone_api.common.isNull(jobj)) {
              continue;
            }
            if (
              webphone_api.common.isNull(jobj.n) ||
              webphone_api.common.isNull(jobj.c)
            ) {
              continue;
            }
            ...
            if (webphone_api.common.isNull(name)) {
              name = "";
            }
        ...
        if (
          typeof resp === "string" &&
          resp.indexOf("HttpRequest exception") >= 0
        ) {
          webphone_api.common.ShowToast(
            "Can't load fileds. Please try again later.",
          );
          return;
        }
        //BRANDSTART
        if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
          ...
          if (!webphone_api.common.isNull(error) && error.length > 0) {
            webphone_api.common.PutToDebugLog(
              3,
              "ERROR, newuserreg httpresponsehandler rec error: " + error,
            );
            webphone_api.common.ShowToast(error);
            return;
          }
          ...
          if (webphone_api.common.isNull(jdata)) {
            webphone_api.common.PutToDebugLog(
              3,
              "ERROR, newuserreg httpresponsehandler data is NULL",
            );
          ...
          for (var i = 0; i < jarray.length; i++) {
            ...
            if (
              webphone_api.common.isNull(jobj["name"]) ||
              webphone_api.common.isNull(jobj["displayName"]) ||
              webphone_api.common.isNull(jobj["type"]) ||
              webphone_api.common.isNull(jobj["value"]) ||
              webphone_api.common.isNull(jobj["mandatory"]) ||
              webphone_api.common.isNull(jobj["validation"])
            ) {
              continue;
            }
            ...
            if (webphone_api.common.isNull(displayName)) {
              displayName = "";
            }
            if (webphone_api.common.isNull(type)) {
              type = "";
            }
            if (webphone_api.common.isNull(defvalue)) {
              defvalue = "";
            }
            if (webphone_api.common.isNull(mandatory)) {
              mandatory = "";
            }
            if (webphone_api.common.isNull(validation)) {
              validation = "";
            }
        ...
        try {
          ...
          if (webphone_api.common.GetConfigInt("brandid", -1) === 50) {
            ...
            if (!webphone_api.common.isNull(error) && error.length > 0) {
              webphone_api.common.PutToDebugLog(
                3,
                "ERROR, newuser_dynamic httpresponsehandler rec error: " +
                  error,
              );
              webphone_api.common.ShowToast(error);
              return;
            ...
            if (webphone_api.common.isNull(jdata)) {
              webphone_api.common.PutToDebugLog(
                3,
                "ERROR, newuser_dynamic httpresponsehandler data is NULL",
              );
            ...
            if (webphone_api.common.isNull(new_usr)) {
              new_usr = "";
            }
            if (webphone_api.common.isNull(new_pwd)) {
              new_pwd = "";
            }
          ...
          //BRANDEND
            ...
            webphone_api.common.PutToDebugLog(
              2,
              "ERROR, _newuser: HttpResponseHandler newuser_dynamic parse resp NOT HANDLED",
            );
        } catch (errin) {
          webphone_api.common.PutToDebugLogException(
            2,
            "_newuser: HttpResponseHandler newuser_dynamic parse resp",
            errin,
          );
        }
      }
  ...
  function GetUriNU() {
    ...
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_newuser: GetUriNU", err);
    }
    return "";
  }

  function GetUriSecondNU() {
    // returns user http req second uri or empty string
    try {
  ...
  function PopulateDynamicFields() {
    ...
    try {
      // dynamically get form fields
      var newuserform = webphone_api.common.GetConfig("newuserform");
      if (webphone_api.common.isNull(newuserform) || newuserform.length < 1) {
        return;
      }
      ...
      if (webphone_api.common.isNull(formf) || formf.length < 1) {
        webphone_api.common.PutToDebugLog(
          3,
          "ERROR,newuserreg PopulateDynamicFields list is empty",
        );
        return;
      }
      ...
      webphone_api
        .$("#page_newuser_content")
        .html(nu_html_content)
        .trigger("create");
      MeasureNewuser();
      setTimeout(function () {
        MeasureNewuser();
      ...
      webphone_api.common.PutToDebugLogException(
        2,
        "_newuser: PopulateDynamicFields",
        err,
      );
    }
  }
  ...
  function IframeOnLoad() {
    // called every time the location (src) of the iframe changes
    try {
      if (webphone_api.common.NuIsWebPage()) {
        ...
        if (!webphone_api.common.isNull(idocument)) {
          if (iframe.location && iframe.location.href) {
            webphone_api.common.PutToDebugLog(
              2,
              "EVENT, _newuser IframeOnLoad new location: " +
          ...
          var pageContent = "";
          if (
            typeof idocument.documentElement !== "undefined" &&
            idocument.documentElement !== null
          ) {
            if (
              typeof idocument.documentElement.innerHTML !== "undefined" &&
              idocument.documentElement.innerHTML !== null
            ) {
              ...
              webphone_api.common.HandleNewUserResult(
                pageContent,
                idocument.documentElement,
              );
            } else if (
              typeof idocument.body.innerHTML !== "undefined" &&
              idocument.body.innerHTML !== null
            ) {
  ...
  function CreateOptionsMenu(menuId) {
    ...
    try {
      ...
      if (webphone_api.common.isNull(menuId) || menuId.length < 1) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _newuser: CreateOptionsMenu menuid null",
        );
        return;
      }
      ...
      if (webphone_api.$(menuId).length <= 0) {
        webphone_api.common.PutToDebugLog(
          2,
          "ERROR, _newuser: CreateOptionsMenu can't get reference to Menu",
        );
        return;
      }
  ...
  function onStop(event) {
    try {
      ...
      webphone_api.common.PutToDebugLogException(2, "_newuser: onStop", err);
    }
  }
